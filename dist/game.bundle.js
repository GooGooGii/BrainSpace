...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function vc(){return new rn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ga(),fragmentShader:`
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function Mc(){return new rn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ga(),fragmentShader:`
...
#define LOW_PRECISION`),t}function ym(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===aa?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Tl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===dn&&(t="SHADOWMAP_TYPE_VSM"),t}function vm(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ui:case di:t="ENVMAP_TYPE_CUBE";break;case Ts:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Mm(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case di:t="ENVMAP_MODE_REFRACTION";break}return t}function Sm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ua:t="ENVMAP_BLENDING_MULTIPLY";break;case Wl:t="ENVMAP_BLENDING_MIX";break;case Xl:t="ENVMAP_BLENDING_ADD";break}return t}function bm(i){let t=i.envMapCubeUVHeight;if(t===null)return null;let e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Em(i,t,e,n){let s=i.getContext(),r=e.defines,o=e.vertexShader,a=e.fragmentShader,c=ym(e),l=vm(e),h=Mm(e),u=Sm(e),f=bm(e),p=um(e),_=dm(r),y=s.createProgram(),m,d,w=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Ls).join(`
`)),o=Ba(o),o=Lc(o,e),o=Dc(o,e),a=Ba(a),a=Lc(a,e),a=Dc(a,e),o=Uc(o),a=Uc(a),e.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+d);let T=w+m+o,b=w+d+a,C=Cc(s,s.VERTEX_SHADER,T),A=Cc(s,s.FRAGMENT_SHADER,b);s.attachShader(y,C),s.attachShader(y,A),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function P(I){if(i.debug.checkShaderErrors){let z=s.getProgramInfoLog(y)||"",H=s.getShaderInfoLog(C)||"",X=s.getShaderInfoLog(A)||"",Z=z.trim(),W=H.trim(),et=X.trim(),k=!0,rt=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(k=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,C,A);else{let ht=Pc(s,C,"vertex"),bt=Pc(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
void main() {
...
}`,Va=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new Ss(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new rn({vertexShader:Gm,fragmentShader:Wm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new ae(new li(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Ha=class extends An{constructor(t,e){super();let n=this,s=null,r=1,o=null,a="local-floor",c=1,l=null,h=null,u=null,f=null,p=null,_=null,y=typeof XRWebGLBinding<"u",m=new Va,d={},w=e.getContextAttributes(),T=null,b=null,C=[],A=[],P=new ct,N=null,M=new Ne;M.viewport=new ce;let v=new Ne;v.viewport=new ce;let I=[M,v],z=new Rr,H=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let J=C[q];return J===void 0&&(J=new ki,C[q]=J),J.getTargetRaySpace()},this.getControllerGrip=function(q){let J=C[q];return J===void 0&&(J=new ki,C[q]=J),J.getGripSpace()},this.getHand=function(q){let J=C[q];return J===void 0&&(J=new ki,C[q]=J),J.getHandSpace()};function Z(q){let J=A.indexOf(q.inputSource);if(J===-1)return;let ft=C[J];ft!==void 0&&(ft.update(q.inputSource,q.frame,l||o),ft.dispatchEvent({type:q.type,data:q.inputSource}))}function W(){s.removeEventListener("select",Z),s.removeEventListener("selectstart",Z),s.removeEventListener("selectend",Z),s.removeEventListener("squeeze",Z),s.removeEventListener("squeezestart",Z),s.removeEventListener("squeezeend",Z),s.removeEventListener("end",W),s.removeEventListener("inputsourceschange",et);for(let q=0;q<C.length;q++){let J=A[q];J!==null&&(A[q]=null,C[q].disconnect(J))}H=null,X=null,m.reset();for(let q in d)delete d[q];t.setRenderTarget(T),p=null,f=null,u=null,s=null,b=null,Xt.stop(),n.isPresenting=!1,t.setPixelRatio(N),t.setSize(P.width,P.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){r=q,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){a=q,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||o},this.setReferenceSpace=function(q){l=q},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return u===null&&y&&(u=new XRWebGLBinding(s,e)),u},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(q){if(s=q,s!==null){if(T=t.getRenderTarget(),s.addEventListener("select",Z),s.addEventListener("selectstart",Z),s.addEventListener("selectend",Z),s.addEventListener("squeeze",Z),s.addEventListener("squeezestart",Z),s.addEventListener("squeezeend",Z),s.addEventListener("end",W),s.addEventListener("inputsourceschange",et),w.xrCompatible!==!0&&await e.makeXRCompatible(),N=t.getPixelRatio(),t.getSize(P),y&&"createProjectionLayer"in XRWebGLBinding.prototype){let ft=null,It=null,St=null;w.depth&&(St=w.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,ft=w.stencil?qi:Ni,It=w.stencil?Xi:$n);let Vt={colorFormat:e.RGBA8,depthFormat:St,scaleFactor:r};u=this.getBinding(),f=u.createProjectionLayer(Vt),s.updateRenderState({layers:[f]}),t.setPixelRatio(1),t.setSize(f.textureWidth,f.textureHeight,!1),b=new cn(f.textureWidth,f.textureHeight,{format:$e,type:pn,depthTexture:new Ms(f.textureWidth,f.textureHeight,It,void 0,void 0,void 0,void 0,void 0,void 0,ft),stencilBuffer:w.stencil,colorSpace:t.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let ft={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,e,ft),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),b=new cn(p.framebufferWidth,p.framebufferHeight,{format:$e,type:pn,colorSpace:t.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(c),l=null,o=await s.requestReferenceSpace(a),Xt.setContext(s),Xt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function et(q){for(let J=0;J<q.removed.length;J++){let ft=q.removed[J],It=A.indexOf(ft);It>=0&&(A[It]=null,C[It].disconnect(ft))}for(let J=0;J<q.added.length;J++){let ft=q.added[J],It=A.indexOf(ft);if(It===-1){for(let Vt=0;Vt<C.length;Vt++)if(Vt>=A.length){A.push(ft),It=Vt;break}else if(A[Vt]===null){A[Vt]=ft,It=Vt;break}if(It===-1)break}let St=C[It];St&&St.connect(ft)}}let k=new F,rt=new F;function ht(q,J,ft){k.setFromMatrixPosition(J.matrixWorld),rt.setFromMatrixPosition(ft.matrixWorld);let It=k.distanceTo(rt),St=J.projectionMatrix.elements,Vt=ft.projectionMatrix.elements,Ee=St[14]/(St[10]-1),E=St[14]/(St[10]+1),ie=(St[9]+1)/St[5],Dt=(St[9]-1)/St[5],Rt=(St[8]-1)/St[0],gt=(Vt[8]+1)/Vt[0],se=Ee*Rt,_t=Ee*gt,Ft=It/(-Rt+gt),ye=Ft*-Rt;if(J.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(ye),q.translateZ(Ft),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),St[10]===-1)q.projectionMatrix.copy(J.projectionMatrix),q.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{let ue=Ee+Ft,S=E+Ft,g=se-ye,U=_t+(It-ye),G=ie*E/S*ue,$=Dt*E/S*ue;q.projectionMatrix.makePerspective(g,U,G,$,ue,S),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function bt(q,J){J===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(J.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(s===null)return;let J=q.near,ft=q.far;m.texture!==null&&(m.depthNear>0&&(J=m.depthNear),m.depthFar>0&&(ft=m.depthFar)),z.near=v.near=M.near=J,z.far=v.far=M.far=ft,(H!==z.near||X!==z.far)&&(s.updateRenderState({depthNear:z.near,depthFar:z.far}),H=z.near,X=z.far),z.layers.mask=q.layers.mask|6,M.layers.mask=z.layers.mask&3,v.layers.mask=z.layers.mask&5;let It=q.parent,St=z.cameras;bt(z,It);for(let Vt=0;Vt<St.length;Vt++)bt(St[Vt],It);St.length===2?ht(z,M,v):z.projectionMatrix.copy(M.projectionMatrix),Bt(q,z,It)};function Bt(q,J,ft){ft===null?q.matrix.copy(J.matrixWorld):(q.matrix.copy(ft.matrixWorld),q.matrix.invert(),q.matrix.multiply(J.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(J.projectionMatrix),q.projectionMatrixInverse.copy(J.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=Fi*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return z},this.getFoveation=function(){if(!(f===null&&p===null))return c},this.setFoveation=function(q){c=q,f!==null&&(f.fixedFoveation=q),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=q)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(z)},this.getCameraTexture=function(q){return d[q]};let Kt=null;function ne(q,J){if(h=J.getViewerPose(l||o),_=J,h!==null){let ft=h.views;p!==null&&(t.setRenderTargetFramebuffer(b,p.framebuffer),t.setRenderTarget(b));let It=!1;ft.length!==z.cameras.length&&(z.cameras.length=0,It=!0);for(let E=0;E<ft.length;E++){let ie=ft[E],Dt=null;if(p!==null)Dt=p.getViewport(ie);else{let gt=u.getViewSubImage(f,ie);Dt=gt.viewport,E===0&&(t.setRenderTargetTextures(b,gt.colorTexture,gt.depthStencilTexture),t.setRenderTarget(b))}let Rt=I[E];Rt===void 0&&(Rt=new Ne,Rt.layers.enable(E),Rt.viewport=new ce,I[E]=Rt),Rt.matrix.fromArray(ie.transform.matrix),Rt.matrix.decompose(Rt.position,Rt.quaternion,Rt.scale),Rt.projectionMatrix.fromArray(ie.projectionMatrix),Rt.projectionMatrixInverse.copy(Rt.projectionMatrix).invert(),Rt.viewport.set(Dt.x,Dt.y,Dt.width,Dt.height),E===0&&(z.matrix.copy(Rt.matrix),z.matrix.decompose(z.position,z.quaternion,z.scale)),It===!0&&z.cameras.push(Rt)}let St=s.enabledFeatures;if(St&&St.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&y){u=n.getBinding();let E=u.getDepthInformation(ft[0]);E&&E.isValid&&E.texture&&m.init(E,s.renderState)}if(St&&St.includes("camera-access")&&y){t.state.unbindTexture(),u=n.getBinding();for(let E=0;E<ft.length;E++){let ie=ft[E].camera;if(ie){let Dt=d[ie];Dt||(Dt=new Ss,d[ie]=Dt);let Rt=u.getCameraImage(ie);Dt.sourceTexture=Rt}}}}for(let ft=0;ft<C.length;ft++){let It=A[ft],St=C[ft];It!==null&&St!==void 0&&St.update(It,J,l||o)}Kt&&Kt(q,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),_=null}let Xt=new zc;Xt.setAnimationLoop(ne),this.setAnimationLoop=function(q){Kt=q},this.dispose=function(){}}},mi=new hn,Xm=new ge;function qm(i,t){function e(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,Ta(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function s(m,d,w,T,b){d.isMeshBasicMaterial||d.isMeshLambertMaterial?r(m,d):d.isMeshToonMaterial?(r(m,d),u(m,d)):d.isMeshPhongMaterial?(r(m,d),h(m,d)):d.isMeshStandardMaterial?(r(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,b)):d.isMeshMatcapMaterial?(r(m,d),_(m,d)):d.isMeshDepthMaterial?r(m,d):d.isMeshDistanceMaterial?(r(m,d),y(m,d)):d.isMeshNormalMaterial?r(m,d):d.isLineBasicMaterial?(o(m,d),d.isLineDashedMaterial&&a(m,d)):d.isPointsMaterial?c(m,d,w,T):d.isSpriteMaterial?l(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function r(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,e(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Le&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,e(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Le&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,e(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,e(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,e(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);let w=t.get(d),T=w.envMap,b=w.envMapRotation;T&&(m.envMap.value=T,mi.copy(b),mi.x*=-1,mi.y*=-1,mi.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(mi.y*=-1,mi.z*=-1),m.envMapRotation.value.setFromMatrix4(Xm.makeRotationFromEuler(mi)),m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,e(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,e(d.aoMap,m.aoMapTransform))}function o(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform))}function a(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function c(m,d,w,T){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*w,m.scale.value=T*.5,d.map&&(m.map.value=d.map,e(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function l(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function h(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function u(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,e(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,e(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,w){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,e(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,e(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,e(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,e(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,e(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Le&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,e(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,e(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,e(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,e(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,e(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,e(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,e(d.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,d){d.matcap&&(m.matcap.value=d.matcap)}function y(m,d){let w=t.get(d).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Ym(i,t,e,n){let s={},r={},o=[],a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(w,T){let b=T.program;n.uniformBlockBinding(w,b)}function l(w,T){let b=s[w.id];b===void 0&&(_(w),b=h(w),s[w.id]=b,w.addEventListener("dispose",m));let C=T.program;n.updateUBOMapping(w,C);let A=t.render.frame;r[w.id]!==A&&(f(w),r[w.id]=A)}function h(w){let T=u();w.__bindingPointIndex=T;let b=i.createBuffer(),C=w.__size,A=w.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,C,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,b),b}function u(){for(let w=0;w<a;w++)if(o.indexOf(w)===-1)return o.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(w){let T=s[w.id],b=w.uniforms,C=w.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let A=0,P=b.length;A<P;A++){let N=Array.isArray(b[A])?b[A]:[b[A]];for(let M=0,v=N.length;M<v;M++){let I=N[M];if(p(I,A,M,C)===!0){let z=I.__offset,H=Array.isArray(I.value)?I.value:[I.value],X=0;for(let Z=0;Z<H.length;Z++){let W=H[Z],et=y(W);typeof W=="number"||typeof W=="boolean"?(I.__data[0]=W,i.bufferSubData(i.UNIFORM_BUFFER,z+X,I.__data)):W.isMatrix3?(I.__data[0]=W.elements[0],I.__data[1]=W.elements[1],I.__data[2]=W.elements[2],I.__data[3]=0,I.__data[4]=W.elements[3],I.__data[5]=W.elements[4],I.__data[6]=W.elements[5],I.__data[7]=0,I.__data[8]=W.elements[6],I.__data[9]=W.elements[7],I.__data[10]=W.elements[8],I.__data[11]=0):(W.toArray(I.__data,X),X+=et.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,z,I.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(w,T,b,C){let A=w.value,P=T+"_"+b;if(C[P]===void 0)return typeof A=="number"||typeof A=="boolean"?C[P]=A:C[P]=A.clone(),!0;{let N=C[P];if(typeof A=="number"||typeof A=="boolean"){if(N!==A)return C[P]=A,!0}else if(N.equals(A)===!1)return N.copy(A),!0}return!1}function _(w){let T=w.uniforms,b=0,C=16;for(let P=0,N=T.length;P<N;P++){let M=Array.isArray(T[P])?T[P]:[T[P]];for(let v=0,I=M.length;v<I;v++){let z=M[v],H=Array.isArray(z.value)?z.value:[z.value];for(let X=0,Z=H.length;X<Z;X++){let W=H[X],et=y(W),k=b%C,rt=k%et.boundary,ht=k+rt;b+=rt,ht!==0&&C-ht<et.storage&&(b+=C-ht),z.__data=new Float32Array(et.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=b,b+=et.storage}}}let A=b%C;return A>0&&(b+=C-A),w.__size=b,w.__cache={},this}function y(w){let T={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(T.boundary=4,T.storage=4):w.isVector2?(T.boundary=8,T.storage=8):w.isVector3||w.isColor?(T.boundary=16,T.storage=12):w.isVector4?(T.boundary=16,T.storage=16):w.isMatrix3?(T.boundary=48,T.storage=48):w.isMatrix4?(T.boundary=64,T.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),T}function m(w){let T=w.target;T.removeEventListener("dispose",m);let b=o.indexOf(T.__bindingPointIndex);o.splice(b,1),i.deleteBuffer(s[T.id]),delete s[T.id],delete r[T.id]}function d(){for(let w in s)i.deleteBuffer(s[w]);o=[],s={},r={}}return{bind:c,update:l,dispose:d}}var Eo=class{constructor(t={}){let{canvas:e=uc(),context:n=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:f=!1}=t;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=o;let _=new Uint32Array(4),y=new Int32Array(4),m=null,d=null,w=[],T=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=In,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let b=this,C=!1;this._outputColorSpace=Pe;let A=0,P=0,N=null,M=-1,v=null,I=new ce,z=new ce,H=null,X=new Wt(0),Z=0,W=e.width,et=e.height,k=1,rt=null,ht=null,bt=new ce(0,0,W,et),Bt=new ce(0,0,W,et),Kt=!1,ne=new vs,Xt=!1,q=!1,J=new ge,ft=new F,It=new ce,St={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Vt=!1;function Ee(){return N===null?k:1}let E=n;function ie(x,L){return e.getContext(x,L)}try{let x={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"180"}`),e.addEventListener("webglcontextlost",it,!1),e.addEventListener("webglcontextrestored",dt,!1),e.addEventListener("webglcontextcreationerror",K,!1),E===null){let L="webgl2";if(E=ie(L,x),E===null)throw ie(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw console.error("THREE.WebGLRenderer: "+x.message),x}let Dt,Rt,gt,se,_t,Ft,ye,ue,S,g,U,G,$,V,Mt,nt,xt,yt,j,lt,At,vt,ot,Nt;function R(){Dt=new up(E),Dt.init(),vt=new Hm(E,Dt),Rt=new sp(E,Dt,t,vt),gt=new km(E,Dt),Rt.reversedDepthBuffer&&f&&gt.buffers.depth.setReversed(!0),se=new pp(E),_t=new Am,Ft=new Vm(E,Dt,gt,_t,Rt,vt,se),ye=new op(b),ue=new hp(b),S=new yu(E),ot=new np(E,S),g=new dp(E,S,se,ot),U=new gp(E,g,S,se),j=new mp(E,Rt,Ft),nt=new rp(_t),G=new wm(b,ye,ue,Dt,Rt,ot,nt),$=new qm(b,_t),V=new Cm,Mt=new Nm(Dt),yt=new ep(b,ye,ue,gt,U,p,c),xt=new Bm(b,U,Rt),Nt=new Ym(E,se,Rt,gt),lt=new ip(E,Dt,se),At=new fp(E,Dt,se),se.programs=G.programs,b.capabilities=Rt,b.extensions=Dt,b.properties=_t,b.renderLists=V,b.shadowMap=xt,b.state=gt,b.info=se}R();let tt=new Ha(b,E);this.xr=tt,this.getContext=function(){return E},this.getContextAttributes=function(){return E.getContextAttributes()},this.forceContextLoss=function(){let x=Dt.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){let x=Dt.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return k},this.setPixelRatio=function(x){x!==void 0&&(k=x,this.setSize(W,et,!1))},this.getSize=function(x){return x.set(W,et)},this.setSize=function(x,L,O=!0){if(tt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}W=x,et=L,e.width=Math.floor(x*k),e.height=Math.floor(L*k),O===!0&&(e.style.width=x+"px",e.style.height=L+"px"),this.setViewport(0,0,x,L)},this.getDrawingBufferSize=function(x){return x.set(W*k,et*k).floor()},this.setDrawingBufferSize=function(x,L,O){W=x,et=L,k=O,e.width=Math.floor(x*O),e.height=Math.floor(L*O),this.setViewport(0,0,x,L)},this.getCurrentViewport=function(x){return x.copy(I)},this.getViewport=function(x){return x.copy(bt)},this.setViewport=function(x,L,O,B){x.isVector4?bt.set(x.x,x.y,x.z,x.w):bt.set(x,L,O,B),gt.viewport(I.copy(bt).multiplyScalar(k).round())},this.getScissor=function(x){return x.copy(Bt)},this.setScissor=function(x,L,O,B){x.isVector4?Bt.set(x.x,x.y,x.z,x.w):Bt.set(x,L,O,B),gt.scissor(z.copy(Bt).multiplyScalar(k).round())},this.getScissorTest=function(){return Kt},this.setScissorTest=function(x){gt.setScissorTest(Kt=x)},this.setOpaqueSort=function(x){rt=x},this.setTransparentSort=function(x){ht=x},this.getClearColor=function(x){return x.copy(yt.getClearColor())},this.setClearColor=function(){yt.setClearColor(...arguments)},this.getClearAlpha=function(){return yt.getClearAlpha()},this.setClearAlpha=function(){yt.setClearAlpha(...arguments)},this.clear=function(x=!0,L=!0,O=!0){let B=0;if(x){let D=!1;if(N!==null){let Q=N.texture.format;D=Q===Wr||Q===Gr||Q===Hr}if(D){let Q=N.texture.type,at=Q===pn||Q===$n||Q===Gi||Q===Xi||Q===kr||Q===Vr,pt=yt.getClearColor(),ut=yt.getClearAlpha(),wt=pt.r,Ct=pt.g,Et=pt.b;at?(_[0]=wt,_[1]=Ct,_[2]=Et,_[3]=ut,E.clearBufferuiv(E.COLOR,0,_)):(y[0]=wt,y[1]=Ct,y[2]=Et,y[3]=ut,E.clearBufferiv(E.COLOR,0,y))}else B|=E.COLOR_BUFFER_BIT}L&&(B|=E.DEPTH_BUFFER_BIT),O&&(B|=E.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),E.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",it,!1),e.removeEventListener("webglcontextrestored",dt,!1),e.removeEventListener("webglcontextcreationerror",K,!1),yt.dispose(),V.dispose(),Mt.dispose(),_t.dispose(),ye.dispose(),ue.dispose(),U.dispose(),ot.dispose(),Nt.dispose(),G.dispose(),tt.dispose(),tt.removeEventListener("sessionstart",an),tt.removeEventListener("sessionend",ja),Kn.stop()};function it(x){x.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),C=!0}function dt(){console.log("THREE.WebGLRenderer: Context Restored."),C=!1;let x=se.autoReset,L=xt.enabled,O=xt.autoUpdate,B=xt.needsUpdate,D=xt.type;R(),se.autoReset=x,xt.enabled=L,xt.autoUpdate=O,xt.needsUpdate=B,xt.type=D}function K(x){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function Y(x){let L=x.target;L.removeEventListener("dispose",Y),mt(L)}function mt(x){Pt(x),_t.remove(x)}function Pt(x){let L=_t.get(x).programs;L!==void 0&&(L.forEach(function(O){G.releaseProgram(O)}),x.isShaderMaterial&&G.releaseShaderCache(x))}this.renderBufferDirect=function(x,L,O,B,D,Q){L===null&&(L=St);let at=D.isMesh&&D.matrixWorld.determinant()<0,pt=yh(x,L,O,B,D);gt.setMaterial(B,at);let ut=O.index,wt=1;if(B.wireframe===!0){if(ut=g.getWireframeAttribute(O),ut===void 0)return;wt=2}let Ct=O.drawRange,Et=O.attributes.position,zt=Ct.start*wt,Zt=(Ct.start+Ct.count)*wt;Q!==null&&(zt=Math.max(zt,Q.start*wt),Zt=Math.min(Zt,(Q.start+Q.count)*wt)),ut!==null?(zt=Math.max(zt,0),Zt=Math.min(Zt,ut.count)):Et!=null&&(zt=Math.max(zt,0),Zt=Math.min(Zt,Et.count));let le=Zt-zt;if(le<0||le===1/0)return;ot.setup(D,B,pt,O,ut);let jt,$t=lt;if(ut!==null&&(jt=S.get(ut),$t=At,$t.setIndex(jt)),D.isMesh)B.wireframe===!0?(gt.setLineWidth(B.wireframeLinewidth*Ee()),$t.setMode(E.LINES)):$t.setMode(E.TRIANGLES);else if(D.isLine){let Tt=B.linewidth;Tt===void 0&&(Tt=1),gt.setLineWidth(Tt*Ee()),D.isLineSegments?$t.setMode(E.LINES):D.isLineLoop?$t.setMode(E.LINE_LOOP):$t.setMode(E.LINE_STRIP)}else D.isPoints?$t.setMode(E.POINTS):D.isSprite&&$t.setMode(E.TRIANGLES);if(D.isBatchedMesh)if(D._multiDrawInstances!==null)Oi("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),$t.renderMultiDrawInstances(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount,D._multiDrawInstances);else if(Dt.get("WEBGL_multi_draw"))$t.renderMultiDraw(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount);else{let Tt=D._multiDrawStarts,re=D._multiDrawCounts,Gt=D._multiDrawCount,Fe=ut?S.get(ut).bytesPerElement:1,vi=_t.get(B).currentProgram.getUniforms();for(let Oe=0;Oe<Gt;Oe++)vi.setValue(E,"_gl_DrawID",Oe),$t.render(Tt[Oe]/Fe,re[Oe])}else if(D.isInstancedMesh)$t.renderInstances(zt,le,D.count);else if(O.isInstancedBufferGeometry){let Tt=O._maxInstanceCount!==void 0?O._maxInstanceCount:1/0,re=Math.min(O.instanceCount,Tt);$t.renderInstances(zt,le,re)}else $t.render(zt,le)};function Qt(x,L,O){x.transparent===!0&&x.side===fn&&x.forceSinglePass===!1?(x.side=Le,x.needsUpdate=!0,ks(x,L,O),x.side=wn,x.needsUpdate=!0,ks(x,L,O),x.side=fn):ks(x,L,O)}this.compile=function(x,L,O=null){O===null&&(O=x),d=Mt.get(O),d.init(L),T.push(d),O.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(d.pushLight(D),D.castShadow&&d.pushShadow(D))}),x!==O&&x.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(d.pushLight(D),D.castShadow&&d.pushShadow(D))}),d.setupLights();let B=new Set;return x.traverse(function(D){if(!(D.isMesh||D.isPoints||D.isLine||D.isSprite))return;let Q=D.material;if(Q)if(Array.isArray(Q))for(let at=0;at<Q.length;at++){let pt=Q[at];Qt(pt,O,D),B.add(pt)}else Qt(Q,O,D),B.add(Q)}),d=T.pop(),B},this.compileAsync=function(x,L,O=null){let B=this.compile(x,L,O);return new Promise(D=>{function Q(){if(B.forEach(function(at){_t.get(at).currentProgram.isReady()&&B.delete(at)}),B.size===0){D(x);return}setTimeout(Q,10)}Dt.get("KHR_parallel_shader_compile")!==null?Q():setTimeout(Q,10)})};let qt=null;function yn(x){qt&&qt(x)}function an(){Kn.stop()}function ja(){Kn.start()}let Kn=new zc;Kn.setAnimationLoop(yn),typeof self<"u"&&Kn.setContext(self),this.setAnimationLoop=function(x){qt=x,tt.setAnimationLoop(x),x===null?Kn.stop():Kn.start()},tt.addEventListener("sessionstart",an),tt.addEventListener("sessionend",ja),this.render=function(x,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(C===!0)return;if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),tt.enabled===!0&&tt.isPresenting===!0&&(tt.cameraAutoUpdate===!0&&tt.updateCamera(L),L=tt.getCamera()),x.isScene===!0&&x.onBeforeRender(b,x,L,N),d=Mt.get(x,T.length),d.init(L),T.push(d),J.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),ne.setFromProjectionMatrix(J,tn,L.reversedDepth),q=this.localClippingEnabled,Xt=nt.init(this.clippingPlanes,q),m=V.get(x,w.length),m.init(),w.push(m),tt.enabled===!0&&tt.isPresenting===!0){let Q=b.xr.getDepthSensingMesh();Q!==null&&Po(Q,L,-1/0,b.sortObjects)}Po(x,L,0,b.sortObjects),m.finish(),b.sortObjects===!0&&m.sort(rt,ht),Vt=tt.enabled===!1||tt.isPresenting===!1||tt.hasDepthSensing()===!1,Vt&&yt.addToRenderList(m,x),this.info.render.frame++,Xt===!0&&nt.beginShadows();let O=d.state.shadowsArray;xt.render(O,x,L),Xt===!0&&nt.endShadows(),this.info.autoReset===!0&&this.info.reset();let B=m.opaque,D=m.transmissive;if(d.setupLights(),L.isArrayCamera){let Q=L.cameras;if(D.length>0)for(let at=0,pt=Q.length;at<pt;at++){let ut=Q[at];el(B,D,x,ut)}Vt&&yt.render(x);for(let at=0,pt=Q.length;at<pt;at++){let ut=Q[at];tl(m,x,ut,ut.viewport)}}else D.length>0&&el(B,D,x,L),Vt&&yt.render(x),tl(m,x,L);N!==null&&P===0&&(Ft.updateMultisampleRenderTarget(N),Ft.updateRenderTargetMipmap(N)),x.isScene===!0&&x.onAfterRender(b,x,L),ot.resetDefaultState(),M=-1,v=null,T.pop(),T.length>0?(d=T[T.length-1],Xt===!0&&nt.setGlobalState(b.clippingPlanes,d.state.camera)):d=null,w.pop(),w.length>0?m=w[w.length-1]:m=null};function Po(x,L,O,B){if(x.visible===!1)return;if(x.layers.test(L.layers)){if(x.isGroup)O=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(L);else if(x.isLight)d.pushLight(x),x.castShadow&&d.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||ne.intersectsSprite(x)){B&&It.setFromMatrixPosition(x.matrixWorld).applyMatrix4(J);let at=U.update(x),pt=x.material;pt.visible&&m.push(x,at,pt,O,It.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||ne.intersectsObject(x))){let at=U.update(x),pt=x.material;if(B&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),It.copy(x.boundingSphere.center)):(at.boundingSphere===null&&at.computeBoundingSphere(),It.copy(at.boundingSphere.center)),It.applyMatrix4(x.matrixWorld).applyMatrix4(J)),Array.isArray(pt)){let ut=at.groups;for(let wt=0,Ct=ut.length;wt<Ct;wt++){let Et=ut[wt],zt=pt[Et.materialIndex];zt&&zt.visible&&m.push(x,at,zt,O,It.z,Et)}}else pt.visible&&m.push(x,at,pt,O,It.z,null)}}let Q=x.children;for(let at=0,pt=Q.length;at<pt;at++)Po(Q[at],L,O,B)}function tl(x,L,O,B){let D=x.opaque,Q=x.transmissive,at=x.transparent;d.setupLightsView(O),Xt===!0&&nt.setGlobalState(b.clippingPlanes,O),B&&gt.viewport(I.copy(B)),D.length>0&&zs(D,L,O),Q.length>0&&zs(Q,L,O),at.length>0&&zs(at,L,O),gt.buffers.depth.setTest(!0),gt.buffers.depth.setMask(!0),gt.buffers.color.setMask(!0),gt.setPolygonOffset(!1)}function el(x,L,O,B){if((O.isScene===!0?O.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[B.id]===void 0&&(d.state.transmissionRenderTarget[B.id]=new cn(1,1,{generateMipmaps:!0,type:Dt.has("EXT_color_buffer_half_float")||Dt.has("EXT_color_buffer_float")?Wi:pn,minFilter:Zn,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ht.workingColorSpace}));let Q=d.state.transmissionRenderTarget[B.id],at=B.viewport||I;Q.setSize(at.z*b.transmissionResolutionScale,at.w*b.transmissionResolutionScale);let pt=b.getRenderTarget(),ut=b.getActiveCubeFace(),wt=b.getActiveMipmapLevel();b.setRenderTarget(Q),b.getClearColor(X),Z=b.getClearAlpha(),Z<1&&b.setClearColor(16777215,.5),b.clear(),Vt&&yt.render(O);let Ct=b.toneMapping;b.toneMapping=In;let Et=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),d.setupLightsView(B),Xt===!0&&nt.setGlobalState(b.clippingPlanes,B),zs(x,O,B),Ft.updateMultisampleRenderTarget(Q),Ft.updateRenderTargetMipmap(Q),Dt.has("WEBGL_multisampled_render_to_texture")===!1){let zt=!1;for(let Zt=0,le=L.length;Zt<le;Zt++){let jt=L[Zt],$t=jt.object,Tt=jt.geometry,re=jt.material,Gt=jt.group;if(re.side===fn&&$t.layers.test(B.layers)){let Fe=re.side;re.side=Le,re.needsUpdate=!0,nl($t,O,B,Tt,re,Gt),re.side=Fe,re.needsUpdate=!0,zt=!0}}zt===!0&&(Ft.updateMultisampleRenderTarget(Q),Ft.updateRenderTargetMipmap(Q))}b.setRenderTarget(pt,ut,wt),b.setClearColor(X,Z),Et!==void 0&&(B.viewport=Et),b.toneMapping=Ct}function zs(x,L,O){let B=L.isScene===!0?L.overrideMaterial:null;for(let D=0,Q=x.length;D<Q;D++){let at=x[D],pt=at.object,ut=at.geometry,wt=at.group,Ct=at.material;Ct.allowOverride===!0&&B!==null&&(Ct=B),pt.layers.test(O.layers)&&nl(pt,L,O,ut,Ct,wt)}}function nl(x,L,O,B,D,Q){x.onBeforeRender(b,L,O,B,D,Q),x.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),D.onBeforeRender(b,L,O,B,x,Q),D.transparent===!0&&D.side===fn&&D.forceSinglePass===!1?(D.side=Le,D.needsUpdate=!0,b.renderBufferDirect(O,L,B,D,x,Q),D.side=wn,D.needsUpdate=!0,b.renderBufferDirect(O,L,B,D,x,Q),D.side=fn):b.renderBufferDirect(O,L,B,D,x,Q),x.onAfterRender(b,L,O,B,D,Q)}function ks(x,L,O){L.isScene!==!0&&(L=St);let B=_t.get(x),D=d.state.lights,Q=d.state.shadowsArray,at=D.state.version,pt=G.getParameters(x,D.state,Q,L,O),ut=G.getProgramCacheKey(pt),wt=B.programs;B.environment=x.isMeshStandardMaterial?L.environment:null,B.fog=L.fog,B.envMap=(x.isMeshStandardMaterial?ue:ye).get(x.envMap||B.environment),B.envMapRotation=B.environment!==null&&x.envMap===null?L.environmentRotation:x.envMapRotation,wt===void 0&&(x.addEventListener("dispose",Y),wt=new Map,B.programs=wt);let Ct=wt.get(ut);if(Ct!==void 0){if(B.currentProgram===Ct&&B.lightsStateVersion===at)return sl(x,pt),Ct}else pt.uniforms=G.getUniforms(x),x.onBeforeCompile(pt,b),Ct=G.acquireProgram(pt,ut),wt.set(ut,Ct),B.uniforms=pt.uniforms;let Et=B.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(Et.clippingPlanes=nt.uniform),sl(x,pt),B.needsLights=Mh(x),B.lightsStateVersion=at,B.needsLights&&(Et.ambientLightColor.value=D.state.ambient,Et.lightProbe.value=D.state.probe,Et.directionalLights.value=D.state.directional,Et.directionalLightShadows.value=D.state.directionalShadow,Et.spotLights.value=D.state.spot,Et.spotLightShadows.value=D.state.spotShadow,Et.rectAreaLights.value=D.state.rectArea,Et.ltc_1.value=D.state.rectAreaLTC1,Et.ltc_2.value=D.state.rectAreaLTC2,Et.pointLights.value=D.state.point,Et.pointLightShadows.value=D.state.pointShadow,Et.hemisphereLights.value=D.state.hemi,Et.directionalShadowMap.value=D.state.directionalShadowMap,Et.directionalShadowMatrix.value=D.state.directionalShadowMatrix,Et.spotShadowMap.value=D.state.spotShadowMap,Et.spotLightMatrix.value=D.state.spotLightMatrix,Et.spotLightMap.value=D.state.spotLightMap,Et.pointShadowMap.value=D.state.pointShadowMap,Et.pointShadowMatrix.value=D.state.pointShadowMatrix),B.currentProgram=Ct,B.uniformsList=null,Ct}function il(x){if(x.uniformsList===null){let L=x.currentProgram.getUniforms();x.uniformsList=Ji.seqWithValue(L.seq,x.uniforms)}return x.uniformsList}function sl(x,L){let O=_t.get(x);O.outputColorSpace=L.outputColorSpace,O.batching=L.batching,O.batchingColor=L.batchingColor,O.instancing=L.instancing,O.instancingColor=L.instancingColor,O.instancingMorph=L.instancingMorph,O.skinning=L.skinning,O.morphTargets=L.morphTargets,O.morphNormals=L.morphNormals,O.morphColors=L.morphColors,O.morphTargetsCount=L.morphTargetsCount,O.numClippingPlanes=L.numClippingPlanes,O.numIntersection=L.numClipIntersection,O.vertexAlphas=L.vertexAlphas,O.vertexTangents=L.vertexTangents,O.toneMapping=L.toneMapping}function yh(x,L,O,B,D){L.isScene!==!0&&(L=St),Ft.resetTextureUnits();let Q=L.fog,at=B.isMeshStandardMaterial?L.environment:null,pt=N===null?b.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:oi,ut=(B.isMeshStandardMaterial?ue:ye).get(B.envMap||at),wt=B.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,Ct=!!O.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Et=!!O.morphAttributes.position,zt=!!O.morphAttributes.normal,Zt=!!O.morphAttributes.color,le=In;B.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(le=b.toneMapping);let jt=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,$t=jt!==void 0?jt.length:0,Tt=_t.get(B),re=d.state.lights;if(Xt===!0&&(q===!0||x!==v)){let Ce=x===v&&B.id===M;nt.setState(B,x,Ce)}let Gt=!1;B.version===Tt.__version?(Tt.needsLights&&Tt.lightsStateVersion!==re.state.version||Tt.outputColorSpace!==pt||D.isBatchedMesh&&Tt.batching===!1||!D.isBatchedMesh&&Tt.batching===!0||D.isBatchedMesh&&Tt.batchingColor===!0&&D.colorTexture===null||D.isBatchedMesh&&Tt.batchingColor===!1&&D.colorTexture!==null||D.isInstancedMesh&&Tt.instancing===!1||!D.isInstancedMesh&&Tt.instancing===!0||D.isSkinnedMesh&&Tt.skinning===!1||!D.isSkinnedMesh&&Tt.skinning===!0||D.isInstancedMesh&&Tt.instancingColor===!0&&D.instanceColor===null||D.isInstancedMesh&&Tt.instancingColor===!1&&D.instanceColor!==null||D.isInstancedMesh&&Tt.instancingMorph===!0&&D.morphTexture===null||D.isInstancedMesh&&Tt.instancingMorph===!1&&D.morphTexture!==null||Tt.envMap!==ut||B.fog===!0&&Tt.fog!==Q||Tt.numClippingPlanes!==void 0&&(Tt.numClippingPlanes!==nt.numPlanes||Tt.numIntersection!==nt.numIntersection)||Tt.vertexAlphas!==wt||Tt.vertexTangents!==Ct||Tt.morphTargets!==Et||Tt.morphNormals!==zt||Tt.morphColors!==Zt||Tt.toneMapping!==le||Tt.morphTargetsCount!==$t)&&(Gt=!0):(Gt=!0,Tt.__version=B.version);let Fe=Tt.currentProgram;Gt===!0&&(Fe=ks(B,L,D));let vi=!1,Oe=!1,ns=!1,oe=Fe.getUniforms(),We=Tt.uniforms;if(gt.useProgram(Fe.program)&&(vi=!0,Oe=!0,ns=!0),B.id!==M&&(M=B.id,Oe=!0),vi||v!==x){gt.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),oe.setValue(E,"projectionMatrix",x.projectionMatrix),oe.setValue(E,"viewMatrix",x.matrixWorldInverse);let Ue=oe.map.cameraPosition;Ue!==void 0&&Ue.setValue(E,ft.setFromMatrixPosition(x.matrixWorld)),Rt.logarithmicDepthBuffer&&oe.setValue(E,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&oe.setValue(E,"isOrthographic",x.isOrthographicCamera===!0),v!==x&&(v=x,Oe=!0,ns=!0)}if(D.isSkinnedMesh){oe.setOptional(E,D,"bindMatrix"),oe.setOptional(E,D,"bindMatrixInverse");let Ce=D.skeleton;Ce&&(Ce.boneTexture===null&&Ce.computeBoneTexture(),oe.setValue(E,"boneTexture",Ce.boneTexture,Ft))}D.isBatchedMesh&&(oe.setOptional(E,D,"batchingTexture"),oe.setValue(E,"batchingTexture",D._matricesTexture,Ft),oe.setOptional(E,D,"batchingIdTexture"),oe.setValue(E,"batchingIdTexture",D._indirectTexture,Ft),oe.setOptional(E,D,"batchingColorTexture"),D._colorsTexture!==null&&oe.setValue(E,"batchingColorTexture",D._colorsTexture,Ft));let Xe=O.morphAttributes;if((Xe.position!==void 0||Xe.normal!==void 0||Xe.color!==void 0)&&j.update(D,O,Fe),(Oe||Tt.receiveShadow!==D.receiveShadow)&&(Tt.receiveShadow=D.receiveShadow,oe.setValue(E,"receiveShadow",D.receiveShadow)),B.isMeshGouraudMaterial&&B.envMap!==null&&(We.envMap.value=ut,We.flipEnvMap.value=ut.isCubeTexture&&ut.isRenderTargetTexture===!1?-1:1),B.isMeshStandardMaterial&&B.envMap===null&&L.environment!==null&&(We.envMapIntensity.value=L.environmentIntensity),Oe&&(oe.setValue(E,"toneMappingExposure",b.toneMappingExposure),Tt.needsLights&&vh(We,ns),Q&&B.fog===!0&&$.refreshFogUniforms(We,Q),$.refreshMaterialUniforms(We,B,k,et,d.state.transmissionRenderTarget[x.id]),Ji.upload(E,il(Tt),We,Ft)),B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Ji.upload(E,il(Tt),We,Ft),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&oe.setValue(E,"center",D.center),oe.setValue(E,"modelViewMatrix",D.modelViewMatrix),oe.setValue(E,"normalMatrix",D.normalMatrix),oe.setValue(E,"modelMatrix",D.matrixWorld),B.isShaderMaterial||B.isRawShaderMaterial){let Ce=B.uniformsGroups;for(let Ue=0,Lo=Ce.length;Ue<Lo;Ue++){let Qn=Ce[Ue];Nt.update(Qn,Fe),Nt.bind(Qn,Fe)}}return Fe}function vh(x,L){x.ambientLightColor.needsUpdate=L,x.lightProbe.needsUpdate=L,x.directionalLights.needsUpdate=L,x.directionalLightShadows.needsUpdate=L,x.pointLights.needsUpdate=L,x.pointLightShadows.needsUpdate=L,x.spotLights.needsUpdate=L,x.spotLightShadows.needsUpdate=L,x.rectAreaLights.needsUpdate=L,x.hemisphereLights.needsUpdate=L}function Mh(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(x,L,O){let B=_t.get(x);B.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),_t.get(x.texture).__webglTexture=L,_t.get(x.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:O,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,L){let O=_t.get(x);O.__webglFramebuffer=L,O.__useDefaultFramebuffer=L===void 0};let Sh=E.createFramebuffer();this.setRenderTarget=function(x,L=0,O=0){N=x,A=L,P=O;let B=!0,D=null,Q=!1,at=!1;if(x){let ut=_t.get(x);if(ut.__useDefaultFramebuffer!==void 0)gt.bindFramebuffer(E.FRAMEBUFFER,null),B=!1;else if(ut.__webglFramebuffer===void 0)Ft.setupRenderTarget(x);else if(ut.__hasExternalTextures)Ft.rebindTextures(x,_t.get(x.texture).__webglTexture,_t.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){let Et=x.depthTexture;if(ut.__boundDepthTexture!==Et){if(Et!==null&&_t.has(Et)&&(x.width!==Et.image.width||x.height!==Et.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Ft.setupDepthRenderbuffer(x)}}let wt=x.texture;(wt.isData3DTexture||wt.isDataArrayTexture||wt.isCompressedArrayTexture)&&(at=!0);let Ct=_t.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Ct[L])?D=Ct[L][O]:D=Ct[L],Q=!0):x.samples>0&&Ft.useMultisampledRTT(x)===!1?D=_t.get(x).__webglMultisampledFramebuffer:Array.isArray(Ct)?D=Ct[O]:D=Ct,I.copy(x.viewport),z.copy(x.scissor),H=x.scissorTest}else I.copy(bt).multiplyScalar(k).floor(),z.copy(Bt).multiplyScalar(k).floor(),H=Kt;if(O!==0&&(D=Sh),gt.bindFramebuffer(E.FRAMEBUFFER,D)&&B&&gt.drawBuffers(x,D),gt.viewport(I),gt.scissor(z),gt.setScissorTest(H),Q){let ut=_t.get(x.texture);E.framebufferTexture2D(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_CUBE_MAP_POSITIVE_X+L,ut.__webglTexture,O)}else if(at){let ut=L;for(let wt=0;wt<x.textures.length;wt++){let Ct=_t.get(x.textures[wt]);E.framebufferTextureLayer(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0+wt,Ct.__webglTexture,O,ut)}}else if(x!==null&&O!==0){let ut=_t.get(x.texture);E.framebufferTexture2D(E.FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_2D,ut.__webglTexture,O)}M=-1},this.readRenderTargetPixels=function(x,L,O,B,D,Q,at,pt=0){if(!(x&&x.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ut=_t.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&at!==void 0&&(ut=ut[at]),ut){gt.bindFramebuffer(E.FRAMEBUFFER,ut);try{let wt=x.textures[pt],Ct=wt.format,Et=wt.type;if(!Rt.textureFormatReadable(Ct)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Rt.textureTypeReadable(Et)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=x.width-B&&O>=0&&O<=x.height-D&&(x.textures.length>1&&E.readBuffer(E.COLOR_ATTACHMENT0+pt),E.readPixels(L,O,B,D,vt.convert(Ct),vt.convert(Et),Q))}finally{let wt=N!==null?_t.get(N).__webglFramebuffer:null;gt.bindFramebuffer(E.FRAMEBUFFER,wt)}}},this.readRenderTargetPixelsAsync=async function(x,L,O,B,D,Q,at,pt=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ut=_t.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&at!==void 0&&(ut=ut[at]),ut)if(L>=0&&L<=x.width-B&&O>=0&&O<=x.height-D){gt.bindFramebuffer(E.FRAMEBUFFER,ut);let wt=x.textures[pt],Ct=wt.format,Et=wt.type;if(!Rt.textureFormatReadable(Ct))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Rt.textureTypeReadable(Et))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let zt=E.createBuffer();E.bindBuffer(E.PIXEL_PACK_BUFFER,zt),E.bufferData(E.PIXEL_PACK_BUFFER,Q.byteLength,E.STREAM_READ),x.textures.length>1&&E.readBuffer(E.COLOR_ATTACHMENT0+pt),E.readPixels(L,O,B,D,vt.convert(Ct),vt.convert(Et),0);let Zt=N!==null?_t.get(N).__webglFramebuffer:null;gt.bindFramebuffer(E.FRAMEBUFFER,Zt);let le=E.fenceSync(E.SYNC_GPU_COMMANDS_COMPLETE,0);return E.flush(),await dc(E,le,4),E.bindBuffer(E.PIXEL_PACK_BUFFER,zt),E.getBufferSubData(E.PIXEL_PACK_BUFFER,0,Q),E.deleteBuffer(zt),E.deleteSync(le),Q}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,L=null,O=0){let B=Math.pow(2,-O),D=Math.floor(x.image.width*B),Q=Math.floor(x.image.height*B),at=L!==null?L.x:0,pt=L!==null?L.y:0;Ft.setTexture2D(x,0),E.copyTexSubImage2D(E.TEXTURE_2D,O,0,0,at,pt,D,Q),gt.unbindTexture()};let bh=E.createFramebuffer(),Eh=E.createFramebuffer();this.copyTextureToTexture=function(x,L,O=null,B=null,D=0,Q=null){Q===null&&(D!==0?(Oi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Q=D,D=0):Q=0);let at,pt,ut,wt,Ct,Et,zt,Zt,le,jt=x.isCompressedTexture?x.mipmaps[Q]:x.image;if(O!==null)at=O.max.x-O.min.x,pt=O.max.y-O.min.y,ut=O.isBox3?O.max.z-O.min.z:1,wt=O.min.x,Ct=O.min.y,Et=O.isBox3?O.min.z:0;else{let Xe=Math.pow(2,-D);at=Math.floor(jt.width*Xe),pt=Math.floor(jt.height*Xe),x.isDataArrayTexture?ut=jt.depth:x.isData3DTexture?ut=Math.floor(jt.depth*Xe):ut=1,wt=0,Ct=0,Et=0}B!==null?(zt=B.x,Zt=B.y,le=B.z):(zt=0,Zt=0,le=0);let $t=vt.convert(L.format),Tt=vt.convert(L.type),re;L.isData3DTexture?(Ft.setTexture3D(L,0),re=E.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(Ft.setTexture2DArray(L,0),re=E.TEXTURE_2D_ARRAY):(Ft.setTexture2D(L,0),re=E.TEXTURE_2D),E.pixelStorei(E.UNPACK_FLIP_Y_WEBGL,L.flipY),E.pixelStorei(E.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),E.pixelStorei(E.UNPACK_ALIGNMENT,L.unpackAlignment);let Gt=E.getParameter(E.UNPACK_ROW_LENGTH),Fe=E.getParameter(E.UNPACK_IMAGE_HEIGHT),vi=E.getParameter(E.UNPACK_SKIP_PIXELS),Oe=E.getParameter(E.UNPACK_SKIP_ROWS),ns=E.getParameter(E.UNPACK_SKIP_IMAGES);E.pixelStorei(E.UNPACK_ROW_LENGTH,jt.width),E.pixelStorei(E.UNPACK_IMAGE_HEIGHT,jt.height),E.pixelStorei(E.UNPACK_SKIP_PIXELS,wt),E.pixelStorei(E.UNPACK_SKIP_ROWS,Ct),E.pixelStorei(E.UNPACK_SKIP_IMAGES,Et);let oe=x.isDataArrayTexture||x.isData3DTexture,We=L.isDataArrayTexture||L.isData3DTexture;if(x.isDepthTexture){let Xe=_t.get(x),Ce=_t.get(L),Ue=_t.get(Xe.__renderTarget),Lo=_t.get(Ce.__renderTarget);gt.bindFramebuffer(E.READ_FRAMEBUFFER,Ue.__webglFramebuffer),gt.bindFramebuffer(E.DRAW_FRAMEBUFFER,Lo.__webglFramebuffer);for(let Qn=0;Qn<ut;Qn++)oe&&(E.framebufferTextureLayer(E.READ_FRAMEBUFFER,E.COLOR_ATTACHMENT0,_t.get(x).__webglTexture,D,Et+Qn),E.framebufferTextureLayer(E.DRAW_FRAMEBUFFER,E.COLOR_ATTACHMENT0,_t.get(L).__webglTexture,Q,le+Qn)),E.blitFramebuffer(wt,Ct,at,pt,zt,Zt,at,pt,E.DEPTH_BUFFER_BIT,E.NEAREST);gt.bindFramebuffer(E.READ_FRAMEBUFFER,null),gt.bindFramebuffer(E.DRAW_FRAMEBUFFER,null)}else if(D!==0||x.isRenderTargetTexture||_t.has(x)){let Xe=_t.get(x),Ce=_t.get(L);gt.bindFramebuffer(E.READ_FRAMEBUFFER,bh),gt.bindFramebuffer(E.DRAW_FRAMEBUFFER,Eh);for(let Ue=0;Ue<ut;Ue++)oe?E.framebufferTextureLayer(E.READ_FRAMEBUFFER,E.COLOR_ATTACHMENT0,Xe.__webglTexture,D,Et+Ue):E.framebufferTexture2D(E.READ_FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_2D,Xe.__webglTexture,D),We?E.framebufferTextureLayer(E.DRAW_FRAMEBUFFER,E.COLOR_ATTACHMENT0,Ce.__webglTexture,Q,le+Ue):E.framebufferTexture2D(E.DRAW_FRAMEBUFFER,E.COLOR_ATTACHMENT0,E.TEXTURE_2D,Ce.__webglTexture,Q),D!==0?E.blitFramebuffer(wt,Ct,at,pt,zt,Zt,at,pt,E.COLOR_BUFFER_BIT,E.NEAREST):We?E.copyTexSubImage3D(re,Q,zt,Zt,le+Ue,wt,Ct,at,pt):E.copyTexSubImage2D(re,Q,zt,Zt,wt,Ct,at,pt);gt.bindFramebuffer(E.READ_FRAMEBUFFER,null),gt.bindFramebuffer(E.DRAW_FRAMEBUFFER,null)}else We?x.isDataTexture||x.isData3DTexture?E.texSubImage3D(re,Q,zt,Zt,le,at,pt,ut,$t,Tt,jt.data):L.isCompressedArrayTexture?E.compressedTexSubImage3D(re,Q,zt,Zt,le,at,pt,ut,$t,jt.data):E.texSubImage3D(re,Q,zt,Zt,le,at,pt,ut,$t,Tt,jt):x.isDataTexture?E.texSubImage2D(E.TEXTURE_2D,Q,zt,Zt,at,pt,$t,Tt,jt.data):x.isCompressedTexture?E.compressedTexSubImage2D(E.TEXTURE_2D,Q,zt,Zt,jt.width,jt.height,$t,jt.data):E.texSubImage2D(E.TEXTURE_2D,Q,zt,Zt,at,pt,$t,Tt,jt);E.pixelStorei(E.UNPACK_ROW_LENGTH,Gt),E.pixelStorei(E.UNPACK_IMAGE_HEIGHT,Fe),E.pixelStorei(E.UNPACK_SKIP_PIXELS,vi),E.pixelStorei(E.UNPACK_SKIP_ROWS,Oe),E.pixelStorei(E.UNPACK_SKIP_IMAGES,ns),Q===0&&L.generateMipmaps&&E.generateMipmap(re),gt.unbindTexture()},this.initRenderTarget=function(x){_t.get(x).__webglFramebuffer===void 0&&Ft.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?Ft.setTextureCube(x,0):x.isData3DTexture?Ft.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?Ft.setTexture2DArray(x,0):Ft.setTexture2D(x,0),gt.unbindTexture()},this.resetState=function(){A=0,P=0,N=null,gt.reset(),ot.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return tn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=Ht._getDrawingBufferColorSpace(t),e.unpackColorSpace=Ht._getUnpackColorSpace()}};var Jc=document.querySelector("#canvasMount"),$m=document.querySelector("#gameBoard"),Kc=document.querySelector("#timer"),Jm=document.querySelector("#strokeCount"),ji=document.querySelector("#instruction"),Us=document.querySelector("#resultBanner"),Qc=document.querySelector("#undoButton"),Km=document.querySelector("#dropButton"),Qm=document.querySelector("#resetButton"),Za=document.querySelector("#hintDialog"),jc=document.querySelector("#levelSelect"),th=document.querySelector("#gameApp"),qa=document.querySelector("#levelGrid"),jm=document.querySelector("#progressText"),eh=document.querySelector("#levelMenuButton"),tg=document.querySelector("#missionText"),eg=document.querySelector("#hintTitle"),ng=document.querySelector("#hintBody"),pe={left:-5,right:5,bottom:-7,top:7},Se=.28,Wc=.55,he=.075,Xc=.85,Ns=3,nh=5.5,ih=new ys,de=new Hi(pe.left,pe.right,pe.top,pe.bottom,.1,30);de.position.z=10;var Je=new Eo({antialias:!0,alpha:!0});Je.setPixelRatio(Math.min(devicePixelRatio,2));Je.outputColorSpace=Pe;Jc.appendChild(Je.domElement);var _n=new ke,Jn=new ke;ih.add(_n,Jn);var Un=new nn({color:16315883}),xi=new nn({color:16752412}),ig=new nn({color:13396992}),sg=new nn({color:16315883,transparent:!0,opacity:.22}),rg=new nn({color:15158363,transparent:!0,opacity:.2}),Lt,me=new ct,ee=[],be=null,yi=null,on=!1,xn=!1,sh=0,ts=0,Ao=0,Ya=0,De=0,Dn=new ct(-2.25,5.55),Os=[],es=[],Nn=[],Jt=null,Ln=null,og=[{title:"\u91CD\u529B\u5BE6\u9A57",names:["\u843D\u77F3\u8F49\u5411","\u7A7F\u74B0\u547D\u4E2D","\u53CD\u5F48\u5230\u53F3\u7246","\u9AD8\u7A7A\u6295\u676F","\u504F\u5FC3\u555F\u52D5","\u96D9\u5C64\u659C\u5761","\u7E5E\u7246\u5165\u676F","\u4F4E\u7A7A\u9776\u5FC3","\u6298\u7DDA\u6ED1\u9053","\u5074\u649E\u8F49\u76E4"]},{title:"\u91CD\u5FC3\u5DE5\u623F",names:["\u9577\u687F\u7FFB\u8EAB","\u7A84\u9580\u4E0B\u589C","\u501F\u7246\u56DE\u5F48","\u659C\u5854\u6295\u653E","\u91CD\u9318\u5916\u7DE3","\u4E2D\u592E\u9AD8\u7246","\u7981\u5340\u5F4E\u9053","\u969C\u7919\u9776\u5834","\u5169\u6BB5\u63A5\u529B","\u69D3\u687F\u8F49\u8F2A"]},{title:"\u9F52\u8F2A\u8857\u5340",names:["\u78B0\u649E\u8D77\u6B65","\u9F52\u9593\u7A7F\u68AD","\u9006\u7246\u53CD\u5C04","\u8F49\u8F2A\u6295\u676F","\u9023\u9396\u555F\u52D5","\u9806\u6D41\u96D9\u8F2A","\u8F2A\u4E0B\u7981\u5340","\u9F52\u9802\u9776\u5FC3","\u4E09\u8F2A\u901A\u9053","\u91CD\u7269\u50B3\u52D5"]},{title:"\u7BC0\u594F\u6A5F\u623F",names:["\u8B8A\u901F\u5165\u53E3","\u77AC\u9593\u9776\u5FC3","\u62CD\u7246\u6298\u8FD4","\u7BC0\u594F\u6295\u676F","\u53CD\u8F49\u6642\u523B","\u5FEB\u6162\u96D9\u5C64","\u7981\u5340\u8A08\u6642","\u8F2A\u9593\u5C04\u9580","\u4E09\u62CD\u843D\u7403","\u8B8A\u901F\u9023\u687F"]},{title:"\u5927\u5E2B\u8A66\u7149",names:["\u56DB\u8F2A\u8FF7\u9663","\u7D42\u9EDE\u72D9\u64CA","\u6975\u9650\u53CD\u5F48","\u7D05\u5340\u7A7A\u6295","\u5DE5\u623F\u9EDE\u706B","\u9006\u6D41\u9577\u5ECA","\u504F\u5FC3\u5BC6\u5BA4","\u6A5F\u95DC\u9776\u5834","\u4E94\u8F2A\u63A5\u529B","\u6700\u5F8C\u4E00\u8F49"]}],ag=[["ballBox","target","wall","strokeBox","spinGear","ballBox","strokeBox","target","ballBox","spinGear"],["strokeBox","wall","target","ballBox","spinGear","target","ballBox","strokeBox","wall","spinGear"],["spinGear","ballBox","target","strokeBox","wall","ballBox","spinGear","target","strokeBox","ballBox"],["target","spinGear","ballBox","wall","strokeBox","ballBox","target","spinGear","wall","strokeBox"],["wall","target","spinGear","ballBox","strokeBox","target","ballBox","wall","spinGear","ballBox"]];function lg(i,t,e,n){let s=e?-1:1;if(n){let r=[{style:t%2?"wheel":"cross",x:.2*s,y:-.7,r:.78+i*.035,mode:"impact",damping:Math.max(.45,.8-i*.07)}];return i>=2&&r.push({style:"cross",x:2.25*s,y:2.2,r:.58,mode:"fixed"}),i>=4&&r.push({style:"wheel",x:-2*s,y:-3.2,r:.68,mode:"variable",baseSpeed:-.3*s,amplitude:.9,frequency:1.05}),r}return i===0?t%2?[{style:"cross",x:.3*s,y:-.1,r:.58,mode:"fixed"}]:[]:i===1?[{style:"cross",x:-1.25*s,y:1,r:.62,mode:"fixed"},{style:"cross",x:1.55*s,y:-2.1,r:.56,mode:"fixed"}]:i===2?[{style:"wheel",x:-1.25*s,y:1.25,r:.74,mode:"impact",damping:.65},{style:"wheel",x:1.55*s,y:-2,r:.7,mode:"constant",speed:.82*s}]:i===3?[{style:"wheel",x:-1.55*s,y:1.45,r:.78,mode:"variable",baseSpeed:-.35*s,amplitude:1,frequency:.85+t*.04},{style:"wheel",x:1.45*s,y:-1.75,r:.74,mode:"constant",speed:.9*s}]:[{style:"wheel",x:-2.15*s,y:2.8,r:.7,mode:"variable",baseSpeed:-.4*s,amplitude:1,frequency:1.1},{style:"cross",x:1.65*s,y:2.3,r:.57,mode:"impact",damping:.7},{style:"cross",x:-.5*s,y:-.3,r:.58,mode:"fixed"},{style:"wheel",x:2*s,y:-2.7,r:.7,mode:"constant",speed:.9*s}]}function cg(){let i={ballBox:["\u66FF\u7403\u5B89\u6392\u4E0B\u4E00\u6B21\u78B0\u649E","\u9577\u7DDA\u4E0D\u4E00\u5B9A\u6700\u597D\uFF0C\u77ED\u91CD\u7269\u66F4\u5BB9\u6613\u63A7\u5236\u89D2\u5EA6\u3002"],target:["\u5148\u5C0D\u6E96\u6700\u5F8C\u4E00\u6B21\u53CD\u5F48","\u76EE\u6A19\u53EA\u9700\u8981\u7403\u78B0\u5230\uFF0C\u4E0D\u5FC5\u505C\u5728\u88E1\u9762\u3002"],wall:["\u7246\u9762\u4E5F\u662F\u7D42\u9EDE","\u5229\u7528\u843D\u4E0B\u7269\u7684\u504F\u5FC3\u78B0\u649E\uFF0C\u628A\u7403\u63A8\u5F80\u6307\u5B9A\u5074\u3002"],strokeBox:["\u5148\u8003\u616E\u7269\u4EF6\u7684\u91CD\u5FC3","\u7D05\u8272\u5340\u4E0D\u80FD\u756B\uFF0C\u8B93\u7269\u4EF6\u7FFB\u8F49\u6216\u6ED1\u5165\u676F\u4E2D\u3002"],spinGear:["\u649E\u5916\u7DE3\u624D\u6709\u529B\u77E9","\u91CD\u7269\u64CA\u4E2D\u4E2D\u5FC3\u4E0D\u6613\u65CB\u8F49\uFF0C\u7784\u6E96\u9F52\u8F2A\u5916\u5074\u3002"]};return og.flatMap((t,e)=>t.names.map((n,s)=>{let r=ag[e][s],o=(e+s)%2===1,a=o?-1:1,c=-3.25*a,l=3.35*a,h=l>0?[2.7,4.05,-6.2,-5]:[-4.05,-2.7,-6.2,-5],u=e<2?2:3,f={chapter:t.title,name:n,difficulty:Math.min(4,2+Math.floor(e/2)),strokes:u,mission:"",hintTitle:i[r][0],hint:i[r][1],parTime:16+e*4+s,parStrokes:Math.max(1,u-1),obstacles:lg(e,s,o,r==="spinGear")};if(r==="ballBox")Object.assign(f,{mission:"\u628A\u7403\u9001\u9032\u53E6\u4E00\u5074\u7684\u6A59\u8272\u76D2\u5B50",ball:[c,4.65+s%4*.22],basket:h,goal:{type:r},bars:s%3===0&&e<3?[{x:.15*a,y:-3.45+s%2*.55,length:3.4,thickness:.16,rotation:.16*a}]:[]});else if(r==="target"){let p=-4.4+(s%3-1)*.55,_=e===0?[{x:.3*a,y:3.65,length:3.8,thickness:.16,rotation:(s%2?-.12:.12)*a}]:[];Object.assign(f,{mission:"\u8B93\u7403\u78B0\u5230\u6A59\u8272\u9776\u5FC3",ball:[c,4.7+s%3*.27],goal:{type:r,x:l,y:p,r:Math.max(.4,.58-e*.035)},bars:_})}else if(r==="wall"){let p=c>0?"left":"right";Object.assign(f,{mission:`\u8B93\u7403\u78B0\u5230${p==="left"?"\u5DE6":"\u53F3"}\u5074\u6A59\u8272\u7246\u9762`,ball:[c,4.45+s%4*.24],goal:{type:r,side:p,minY:-4.9+s%3*.5,maxY:.8+s%2*.6},bars:e<2?[{x:-.5*a,y:-1.2+s%3*.45,length:4.7-s%2*.6,thickness:.16,rotation:(.2+e*.025)*a}]:[]})}else if(r==="strokeBox"){let _=((e+s)%2===0?1:-1)>0?[2.7,4.05,-6.2,-5]:[-4.05,-2.7,-6.2,-5],y=(_[0]+_[1])/2;Object.assign(f,{mission:"\u628A\u624B\u7E6A\u7269\u4EF6\u9001\u9032\u6A59\u8272\u676F\u5B50",ball:null,basket:_,goal:{type:r},noDraw:[{x:y,y:-4.75,w:2.1+e*.08,h:3+s%3*.22}],bars:e>0?[{x:.25*a,y:-1.7-s%3*.38,length:3.7+e%2*.35,thickness:.16,rotation:-.2*a}]:[]})}else Object.assign(f,{mission:"\u7528\u624B\u7E6A\u7269\u649E\u52D5\u78B0\u649E\u5F0F\u8F49\u76E4",ball:null,goal:{type:r,speed:.45+e*.07},bars:e>=3?[{x:-2.6*a,y:1.5,length:2.8,thickness:.15,rotation:-.25*a}]:[]});return f}))}var Me=[{name:"\u7B2C\u4E00\u7B46",difficulty:1,strokes:1,mission:"\u756B\u51FA\u4EFB\u610F\u7269\u4EF6",hintTitle:"\u756B\u4EC0\u9EBC\u90FD\u53EF\u4EE5",hint:"\u5728\u6DF1\u8272\u5340\u57DF\u62D6\u52D5\u624B\u6307\uFF0C\u653E\u958B\u5F8C\u7269\u4EF6\u6703\u53D7\u5230\u91CD\u529B\u3002",ball:null,goal:{type:"draw"},parTime:6,parStrokes:1,obstacles:[]},{name:"\u63A8\u5411\u5DE6\u7246",difficulty:1,strokes:1,mission:"\u8B93\u7403\u78B0\u5230\u6A59\u8272\u7246\u9762",hintTitle:"\u7528\u91CD\u91CF\u63A8\u7403",hint:"\u5728\u7403\u7684\u53F3\u4E0A\u65B9\u756B\u4E00\u500B\u6709\u91CD\u91CF\u7684\u659C\u7269\u4EF6\u3002",ball:[1.8,3.8],goal:{type:"wall",side:"left",minY:-4.8,maxY:1.2},parTime:10,parStrokes:1,bars:[{x:-1.3,y:.8,length:4.6,thickness:.16,rotation:-.18}],obstacles:[]},{name:"\u7269\u4EF6\u5165\u676F",difficulty:1,strokes:1,mission:"\u628A\u624B\u7E6A\u7269\u4EF6\u653E\u9032\u6A59\u8272\u676F\u5B50",hintTitle:"\u7D05\u8272\u5340\u4E0D\u80FD\u756B",hint:"\u5728\u676F\u53E3\u4E0A\u65B9\u756B\u4E00\u500B\u5C0F\u7269\u4EF6\uFF0C\u5229\u7528\u91CD\u529B\u8B93\u5B83\u843D\u5165\u676F\u4E2D\u3002",ball:null,basket:[-.8,.8,-5.8,-4.2],goal:{type:"strokeBox"},noDraw:[{x:0,y:-5.1,w:2.3,h:2.7}],parTime:8,parStrokes:1,obstacles:[]},{name:"\u7B2C\u4E00\u9053\u659C\u5761",difficulty:1,strokes:1,mission:"\u628A\u7403\u9001\u9032\u53F3\u4E0B\u65B9\u76D2\u5B50",hintTitle:"\u4E00\u689D\u659C\u7DDA\u5C31\u5920",hint:"\u8B93\u7DDA\u689D\u843D\u4E0B\u5F8C\u5F62\u6210\u5F80\u53F3\u7684\u659C\u5761\u3002",ball:[-3.2,4.9],basket:[2.7,4.05,-6.2,-5],goal:{type:"ballBox"},parTime:12,parStrokes:1,obstacles:[]},{name:"\u8D8A\u904E\u9AD8\u7246",difficulty:2,strokes:2,mission:"\u8B93\u7403\u8D8A\u904E\u4E2D\u592E\u7246\u9032\u76D2\u5B50",hintTitle:"\u5148\u63A5\uFF0C\u518D\u5C0E\u5411",hint:"\u4E0D\u8981\u53EA\u756B\u4E00\u689D\u9577\u659C\u7DDA\uFF1B\u60F3\u60F3\u5982\u4F55\u8B93\u7269\u4EF6\u7684\u91CD\u5FC3\u66FF\u4F60\u6539\u8B8A\u89D2\u5EA6\u3002",ball:[-3.1,5.1],basket:[2.75,4.05,-6.2,-5],goal:{type:"ballBox"},parTime:15,parStrokes:2,bars:[{x:.3,y:-2.9,length:5.1,thickness:.18,rotation:Math.PI/2}],obstacles:[]},{name:"\u7A7F\u904E\u7A84\u9580",difficulty:2,strokes:2,mission:"\u8B93\u7403\u7A7F\u904E\u7F3A\u53E3\u78B0\u5230\u76EE\u6A19",hintTitle:"\u63A7\u5236\u843D\u4E0B\u7684\u65B9\u5411",hint:"\u4E0A\u4E0B\u5169\u9053\u7246\u4E4B\u9593\u53EA\u6709\u4E00\u500B\u5165\u53E3\uFF0C\u77ED\u800C\u91CD\u7684\u5F62\u72C0\u6BD4\u9577\u7DDA\u66F4\u597D\u63A7\u5236\u3002",ball:[-3.2,4.9],goal:{type:"target",x:3.4,y:-4.7,r:.58},parTime:16,parStrokes:2,bars:[{x:.5,y:2.8,length:5.2,thickness:.16,rotation:0},{x:-1.2,y:-1.3,length:5.4,thickness:.16,rotation:0}],obstacles:[{style:"cross",x:1.5,y:.5,r:.62,mode:"fixed"}]},{name:"\u559A\u9192\u8F49\u76E4",difficulty:2,strokes:1,mission:"\u8B93\u767D\u8272\u8F49\u76E4\u8F49\u8D77\u4F86",hintTitle:"\u649E\u504F\u4E00\u9EDE",hint:"\u649E\u4E2D\u5FC3\u53EA\u6703\u63A8\uFF0C\u4E0D\u6703\u8F49\uFF1B\u8B93\u91CD\u7269\u6253\u5728\u8F49\u76E4\u5916\u5074\u3002",ball:null,goal:{type:"spinGear",speed:.5},parTime:10,parStrokes:1,obstacles:[{style:"cross",x:0,y:-1.4,r:.9,mode:"impact",damping:.55}]},{name:"\u501F\u8F2A\u8F49\u5411",difficulty:3,strokes:2,mission:"\u649E\u52D5\u8F49\u76E4\uFF0C\u518D\u628A\u7403\u9001\u9032\u5DE6\u676F",hintTitle:"\u5148\u555F\u52D5\u6A5F\u95DC",hint:"\u78B0\u649E\u5F0F\u8F49\u76E4\u6703\u6162\u6162\u6E1B\u901F\uFF1B\u5148\u8B93\u843D\u4E0B\u7269\u649E\u52D5\u5B83\uFF0C\u518D\u5229\u7528\u65CB\u8F49\u65B9\u5411\u5C0E\u7403\u3002",ball:[3,5.2],basket:[-4,-2.65,-6.2,-5],goal:{type:"ballBox"},parTime:20,parStrokes:2,obstacles:[{style:"wheel",x:.8,y:.8,r:.88,mode:"impact",damping:.5},{style:"cross",x:-1.7,y:-2.5,r:.6,mode:"fixed"}]},{name:"\u9006\u5411\u8F38\u9001",difficulty:3,strokes:2,mission:"\u5229\u7528\u6046\u901F\u9F52\u8F2A\u628A\u7403\u9001\u5F80\u53F3\u5074",hintTitle:"\u78B0\u54EA\u4E00\u5074\u5F88\u91CD\u8981",hint:"\u9F52\u8F2A\u4E0A\u4E0B\u5169\u5074\u7684\u63A8\u52D5\u65B9\u5411\u76F8\u53CD\uFF0C\u5148\u89C0\u5BDF\u518D\u756B\u5C0E\u8ECC\u3002",ball:[-3.25,5.25],basket:[2.75,4.05,-6.2,-5],goal:{type:"ballBox"},parTime:18,parStrokes:2,obstacles:[{style:"wheel",x:-.8,y:.8,r:.9,mode:"constant",speed:-1.05},{style:"cross",x:1.8,y:-2.3,r:.62,mode:"fixed"}]},{name:"\u5F9E\u7981\u5340\u5916\u6295\u653E",difficulty:3,strokes:2,mission:"\u8B93\u624B\u7E6A\u7269\u7A7F\u904E\u969C\u7919\u843D\u5165\u676F\u4E2D",hintTitle:"\u756B\u4E00\u500B\u6703\u7FFB\u8EAB\u7684\u5F62\u72C0",hint:"\u7981\u756B\u5340\u5C01\u4F4F\u76F4\u7DDA\u8DEF\u5F91\uFF0C\u5229\u7528\u504F\u5FC3\u7269\u4EF6\u843D\u5730\u5F8C\u7684\u7FFB\u8F49\u3002",ball:null,basket:[2.7,4,-6.2,-5],goal:{type:"strokeBox"},noDraw:[{x:3.35,y:-4.8,w:2.1,h:3.2}],parTime:18,parStrokes:2,bars:[{x:1.1,y:-2.2,length:4.5,thickness:.16,rotation:-.25}],obstacles:[{style:"cross",x:-1.2,y:.4,r:.7,mode:"fixed"}]},{name:"\u6293\u6E96\u7BC0\u594F",difficulty:4,strokes:3,mission:"\u7A7F\u904E\u5FFD\u5FEB\u5FFD\u6162\u7684\u96D9\u8F2A",hintTitle:"\u7B49\u5F85\u4E5F\u662F\u89E3\u6CD5",hint:"\u8B8A\u901F\u9F52\u8F2A\u6703\u52A0\u901F\u3001\u6E1B\u901F\u751A\u81F3\u53CD\u8F49\uFF1B\u4E0B\u7B46\u7684\u6642\u6A5F\u4E5F\u662F\u89E3\u6CD5\u4E4B\u4E00\u3002",ball:[0,5.45],basket:[-.68,.68,-6.2,-5],goal:{type:"ballBox"},parTime:24,parStrokes:3,obstacles:[{style:"wheel",x:-1.8,y:1.3,r:.85,mode:"variable",baseSpeed:-.45,amplitude:1.1,frequency:1.25},{style:"wheel",x:1.8,y:-1.4,r:.85,mode:"variable",baseSpeed:.4,amplitude:1,frequency:.9}]},{name:"\u9F52\u8F2A\u5DE5\u623F",difficulty:4,strokes:3,mission:"\u7A7F\u8D8A\u56DB\u7A2E\u6A5F\u95DC\u628A\u7403\u9001\u9032\u76D2\u5B50",hintTitle:"\u9010\u6BB5\u89E3\u958B",hint:"\u56FA\u5B9A\u3001\u78B0\u649E\u9A45\u52D5\u3001\u6046\u901F\u8207\u8B8A\u901F\u9F52\u8F2A\u898F\u5247\u90FD\u4E0D\u540C\uFF1B\u5148\u66FF\u7403\u898F\u5283\u4E09\u6BB5\u8DEF\u3002",ball:[-3.2,5.5],basket:[2.75,4.05,-6.25,-5.08],goal:{type:"ballBox"},parTime:30,parStrokes:3,bars:[{x:.2,y:-4,length:3,thickness:.15,rotation:.12}],obstacles:[{style:"wheel",x:-2.2,y:3,r:.75,mode:"variable",baseSpeed:-.5,amplitude:.9,frequency:1.1},{style:"cross",x:1.5,y:3,r:.62,mode:"impact",damping:1.1},{style:"cross",x:-.7,y:.2,r:.6,mode:"fixed"},{style:"wheel",x:2,y:-1.1,r:.8,mode:"constant",speed:.85},{style:"cross",x:-1.3,y:-2.7,r:.58,mode:"impact",damping:.8}]},...cg()];function rh(){try{let i=Math.min(Me.length,Math.max(1,Number(localStorage.getItem("brain-physics-unlocked"))||1)),t=JSON.parse(localStorage.getItem("brain-physics-stars")||"{}");return i===12&&Me.length>12&&Number(t[11])>0&&(i=13,localStorage.setItem("brain-physics-unlocked","13")),i}catch{return 1}}function hg(i){try{localStorage.setItem("brain-physics-unlocked",String(i))}catch{}}function oh(){try{return JSON.parse(localStorage.getItem("brain-physics-stars")||"{}")}catch{return{}}}function ug(i,t){try{let e=oh();e[i]=Math.max(Number(e[i])||0,t),localStorage.setItem("brain-physics-stars",JSON.stringify(e))}catch{}}function Wa(i,t,e,n=Un,s=0){let r=new ae(new Vi(e,48),n);return r.position.set(i,t,s),_n.add(r),r}function dg(i,t,e,n,s=Un){let r=new ae(new ci(n,e,48),s);r.position.set(i,t,0),_n.add(r)}function Ds(i,t,e,n,s=0,r=Un,o=!1){let a=new ae(new sn(e,n,.04),r);if(a.position.set(i,t,0),a.rotation.z=s,_n.add(a),o){let c=Math.cos(s)*e/2,l=Math.sin(s)*e/2;es.push({a:new ct(i-c,t-l),b:new ct(i+c,t+l),radius:n/2})}return a}function ah(i,t,e,n,s,r){let o={x:i,y:t,r:e,group:n,localSegments:s,mode:r.mode,angularVelocity:r.speed??0,baseSpeed:r.baseSpeed??0,amplitude:r.amplitude??0,frequency:r.frequency??1,damping:r.damping??1.1,inertia:Math.max(.5,e*e*2.5)};return Nn.push(o),o}function fg(i,t,e,n){let s=new ke;s.position.set(i,t,0),_n.add(s),s.add(new ae(new Vi(e,48),Un)),Os.push({x:i,y:t,r:e});let r=[];for(let o=0;o<10;o++){let a=o/10*Math.PI*2,c=new ct(Math.cos(a)*(e+.23),Math.sin(a)*(e+.23)),l=new ct(Math.cos(a)*.24,Math.sin(a)*.24),h=new ae(new sn(.48,.11,.04),Un);h.position.set(c.x,c.y,0),h.rotation.z=a,s.add(h),r.push({a:c.clone().sub(l),b:c.clone().add(l),radius:.055})}ah(i,t,e,s,r,n)}function pg(i,t,e,n){let s=new ke;s.position.set(i,t,0),_n.add(s),s.add(new ae(new ci(e*.55,e,48),Un));let r=[],o=40;for(let a=0;a<o;a++){let c=a/o*Math.PI*2,l=(a+1)/o*Math.PI*2;r.push({a:new ct(Math.cos(c)*e,Math.sin(c)*e),b:new ct(Math.cos(l)*e,Math.sin(l)*e),radius:.045})}for(let a of[0,Math.PI/2]){let c=e*2.7,l=new ae(new sn(c,.09,.04),Un);l.rotation.z=a,s.add(l);let h=new ct(Math.cos(a)*c/2,Math.sin(a)*c/2);r.push({a:h.clone().multiplyScalar(-1),b:h,radius:.045})}ah(i,t,e,s,r,n)}function mg(){_n.traverse(i=>{i.geometry&&i.geometry.dispose()}),_n.clear(),Os.length=0,es.length=0,Nn.length=0}function gg(i){if(Lt=null,Jt=i.basket?{left:i.basket[0],right:i.basket[1],bottom:i.basket[2],top:i.basket[3]}:null,Ln=i.goal?.type==="target"?i.goal:null,i.ball&&(Dn=new ct(i.ball[0],i.ball[1])),(i.obstacles??[]).forEach(t=>{let e={mode:t.mode,speed:t.speed,baseSpeed:t.baseSpeed,amplitude:t.amplitude,frequency:t.frequency,damping:t.damping};t.style==="wheel"?fg(t.x,t.y,t.r,e):pg(t.x,t.y,t.r,e)}),(i.bars??[]).forEach(t=>Ds(t.x,t.y,t.length,t.thickness,t.rotation??0,Un,!0)),(i.noDraw??[]).forEach(t=>{let e=new ae(new li(t.w,t.h),rg);e.position.set(t.x,t.y,-.15),_n.add(e)}),Jt&&(Ds(Jt.left,(Jt.bottom+Jt.top)/2,Jt.top-Jt.bottom,.12,Math.PI/2,xi,!0),Ds(Jt.right,(Jt.bottom+Jt.top)/2,Jt.top-Jt.bottom,.12,Math.PI/2,xi,!0),Ds((Jt.left+Jt.right)/2,Jt.bottom,Jt.right-Jt.left,.12,0,xi,!0)),Ln&&(dg(Ln.x,Ln.y,Ln.r+.12,Ln.r,xi),Wa(Ln.x,Ln.y,Ln.r*.32,xi,-.02)),i.goal?.type==="wall"){let t=i.goal.side==="left"?pe.left+.08:pe.right-.08;Ds(t,(i.goal.minY+i.goal.maxY)/2,i.goal.maxY-i.goal.minY,.16,Math.PI/2,xi,!0)}if(i.ball){Wa(Dn.x,Dn.y,Se+.09,ig,-.02),Lt=Wa(Dn.x,Dn.y,Se,xi,.2);let t=new ae(new ci(.46,.5,40),sg);t.position.set(Dn.x,Dn.y,0),_n.add(t)}}function $a(){return{left:de.left,right:de.right,bottom:de.bottom,top:de.top}}function lh(i){let t=Je.domElement.getBoundingClientRect();return new ct(de.left+(i.clientX-t.left)/t.width*(de.right-de.left),de.top-(i.clientY-t.top)/t.height*(de.top-de.bottom))}function ch(i){let t=$a();return i.x>t.left+.18&&i.x<t.right-.18&&i.y>t.bottom+.18&&i.y<t.top-.18}function qc(i,t,e=0,n=0){let s=Math.cos(t),r=Math.sin(t);return new ct(e+i.x*s-i.y*r,n+i.x*r+i.y*s)}function Ja(i){return i.localSegments.map(t=>({a:qc(t.a,i.group.rotation.z,i.x,i.y),b:qc(t.b,i.group.rotation.z,i.x,i.y),radius:t.radius,gear:i}))}function Yc(i,t,e){return i.distanceTo(Ro(i,t,e))}function hh(i){if(!ch(i)||Lt&&i.distanceTo(new ct(Lt.position.x,Lt.position.y))<Se+he+.045)return!1;for(let n of Me[De].noDraw??[])if(Math.abs(i.x-n.x)<n.w/2+he&&Math.abs(i.y-n.y)<n.h/2+he)return!1;for(let n of Os)if(i.distanceTo(new ct(n.x,n.y))<n.r+he+.045)return!1;let e=es.concat(Nn.flatMap(Ja));for(let n of e)if(Yc(i,n.a,n.b)<n.radius+he+.045)return!1;for(let n of ee){let s=Fs(n);for(let r=1;r<s.length;r++)if(Yc(i,s[r-1],s[r])<he*2+.045)return!1}return!0}function _g(i,t){let e=i.distanceTo(t),n=Math.max(1,Math.ceil(e/.055));for(let s=1;s<=n;s++)if(!hh(i.clone().lerp(t,s/n)))return!1;return!0}function xg(i,t){let e=t.clone().sub(i),n=e.length();if(n<.01)return null;let s=new ae(new sn(n,he*2,.08),Un);return s.position.set((i.x+t.x)/2,(i.y+t.y)/2,.12),s.rotation.z=Math.atan2(e.y,e.x),Jn.add(s),s}function yg(i){if(xn||ee.length>=Ns||yi!==null)return;i.preventDefault(),yi=i.pointerId;try{Je.domElement.setPointerCapture(i.pointerId)}catch{}let t=lh(i);if(!hh(t)){yi=null,ji.textContent="\u4E0D\u80FD\u5F9E\u7403\u3001\u9F52\u8F2A\u6216\u65E2\u6709\u7DDA\u689D\u4E0A\u958B\u59CB\u7E6A\u88FD";return}be={points:[t],meshes:[]},ji.textContent="\u7E7C\u7E8C\u62D6\u52D5\uFF0C\u653E\u958B\u5F8C\u7DDA\u689D\u6703\u958B\u59CB\u6389\u843D"}function vg(i){if(i.pointerId!==yi||!be)return;i.preventDefault();let t=lh(i);if(!ch(t))return;let e=be.points[be.points.length-1];if(t.distanceTo(e)<.11)return;if(!_g(e,t)){ji.textContent="\u7DDA\u689D\u4E0D\u80FD\u7A7F\u904E\u65E2\u6709\u7269\u4EF6";return}let n=xg(e,t);n&&be.meshes.push(n),be.points.push(t)}function Mg(i){let t=0,e=new ct,n=[];for(let h=1;h<i.points.length;h++){let u=i.points[h-1],f=i.points[h],p=u.distanceTo(f);if(p<1e-4)continue;let _=u.clone().add(f).multiplyScalar(.5);n.push({length:p,midpoint:_}),e.addScaledVector(_,p),t+=p}let s=t>0?e.multiplyScalar(1/t):i.points[0].clone(),r=Math.max(.001,t*Xc),o=Math.max(.35,r),a=o/r,c=0;for(let h of n){let u=h.length*Xc*a,f=h.midpoint.distanceToSquared(s);c+=u*(f+h.length*h.length/12+he*he/2)}let l=new ke;return l.position.set(s.x,s.y,0),Jn.add(l),i.meshes.forEach(h=>l.attach(h)),{group:l,meshes:i.meshes,localPoints:i.points.map(h=>h.clone().sub(s)),velocity:new ct,angularVelocity:0,mass:o,inertia:Math.max(.02,c)}}function uh(i){i.pointerId===yi&&(i.preventDefault(),be&&be.points.length>1?(ee.push(Mg(be)),on||bg(),ph()):be?.meshes.forEach(t=>Jn.remove(t)),be=null,yi=null,Bs(),xn||(ji.textContent=ee.length<Ns?`\u7269\u4EF6\u6B63\u5728\u904B\u52D5\uFF0C\u9084\u53EF\u4EE5\u756B ${Ns-ee.length} \u7B46`:"\u7B46\u6578\u7528\u5B8C\u4E86\uFF0C\u89C0\u5BDF\u7269\u7406\u7D50\u679C"))}Je.domElement.addEventListener("pointerdown",yg,{passive:!1});Je.domElement.addEventListener("pointermove",vg,{passive:!1});Je.domElement.addEventListener("pointerup",uh,{passive:!1});Je.domElement.addEventListener("pointercancel",uh,{passive:!1});Je.domElement.addEventListener("contextmenu",i=>i.preventDefault());function Bs(){Jm.textContent=`${ee.length} / ${Ns}`,Qc.disabled=on||ee.length===0,Km.disabled=!0}function Ka(i){Jn.remove(i.group),i.meshes.forEach(t=>t.geometry.dispose())}function Sg(){on||!ee.length||(Ka(ee.pop()),Bs())}function Qa(){on=!1,xn=!1,ts=0,Ao=0,yi=null,be&&be.meshes.forEach(i=>Jn.remove(i)),be=null,Lt&&Lt.position.set(Dn.x,Dn.y,.2),me.set(0,0),Ya=0,Nn.forEach(i=>{i.group.rotation.z=0,i.angularVelocity=i.mode==="constant"?i.angularVelocity:0}),ee.forEach(Ka),ee=[],Kc.textContent="0.0",Us.className="result-banner",Us.textContent="",ji.textContent="\u756B\u7B2C\u4E00\u7B46\uFF0C\u653E\u958B\u5F8C\u7269\u7406\u7ACB\u5373\u958B\u59CB",Bs()}function bg(){on||xn||(on=!0,sh=performance.now()-ts*1e3,me.set(.08,0),Bs())}function Ro(i,t,e){let n=e.clone().sub(t),s=n.lengthSq();if(!s)return t.clone();let r=Ps.clamp(i.clone().sub(t).dot(n)/s,0,1);return t.clone().addScaledVector(n,r)}function Fs(i){let t=i.group.rotation.z,e=Math.cos(t),n=Math.sin(t);return i.localPoints.map(s=>new ct(i.group.position.x+s.x*e-s.y*n,i.group.position.y+s.x*n+s.y*e))}function Co(i,t){return i.x*t.y-i.y*t.x}function Zc(i,t){let e=t.clone().sub(new ct(i.group.position.x,i.group.position.y));return i.velocity.clone().add(new ct(-i.angularVelocity*e.y,i.angularVelocity*e.x))}function wo(i,t,e,n=new ct,s=.16,r=.42){let o=e.clone().sub(new ct(i.group.position.x,i.group.position.y)),a=Zc(i,e).sub(n),c=a.dot(t);if(c>=0)return 0;let l=Co(o,t),h=1/i.mass+l*l/i.inertia,u=-(1+s)*c/h;i.velocity.addScaledVector(t,u/i.mass),i.angularVelocity+=l*u/i.inertia,a=Zc(i,e).sub(n);let f=a.clone().addScaledVector(t,-a.dot(t));if(f.lengthSq()>1e-6){f.normalize();let p=Co(o,f),_=1/i.mass+p*p/i.inertia,y=-a.dot(f)/_,m=Ps.clamp(y,-r*u,r*u);i.velocity.addScaledVector(f,m/i.mass),i.angularVelocity+=p*m/i.inertia}return u}function dh(i,t){let e=t.clone().sub(new ct(i.x,i.y));return new ct(-i.angularVelocity*e.y,i.angularVelocity*e.x)}function fh(i,t,e,n){if(i.mode!=="impact"||n<=0)return;let s=t.clone().sub(new ct(i.x,i.y)),r=-e.x*n,o=-e.y*n;i.angularVelocity+=(s.x*o-s.y*r)/i.inertia*.55,i.angularVelocity=Ps.clamp(i.angularVelocity,-4.5,4.5)}function Eg(i){Ya+=i,Nn.forEach(t=>{t.mode==="fixed"&&(t.angularVelocity=0),t.mode==="constant"&&(t.angularVelocity=t.angularVelocity||.82),t.mode==="variable"&&(t.angularVelocity=t.baseSpeed+Math.sin(Ya*t.frequency)*t.amplitude),t.mode==="impact"&&(t.angularVelocity*=Math.exp(-t.damping*i)),t.group.rotation.z+=t.angularVelocity*i})}function Tg(i){let t=$a(),e=Nn.flatMap(Ja);for(let n=0;n<2;n++){let s=Fs(i),r=[{normal:new ct(1,0),depthFor:o=>t.left+he-o.x},{normal:new ct(-1,0),depthFor:o=>o.x+he-t.right},{normal:new ct(0,1),depthFor:o=>t.bottom+he-o.y},{normal:new ct(0,-1),depthFor:o=>o.y+he-t.top}];for(let o of r){let a=null;for(let c of s){let l=o.depthFor(c);l>0&&(!a||l>a.depth)&&(a={point:c,depth:l})}a&&(i.group.position.x+=o.normal.x*a.depth,i.group.position.y+=o.normal.y*a.depth,wo(i,o.normal,a.point,void 0,.12,.5))}for(let o of Fs(i)){for(let a of Os){let c=o.clone().sub(new ct(a.x,a.y)),l=a.r+he,h=c.length();if(h>0&&h<l){let u=c.multiplyScalar(1/h);i.group.position.x+=u.x*(l-h),i.group.position.y+=u.y*(l-h),wo(i,u,o)}}for(let a of es){let c=Ro(o,a.a,a.b),l=o.clone().sub(c),h=he+a.radius,u=l.length();if(u>0&&u<h){let f=l.multiplyScalar(1/u);i.group.position.x+=f.x*(h-u),i.group.position.y+=f.y*(h-u),wo(i,f,c)}}for(let a of e){let c=Ro(o,a.a,a.b),l=o.clone().sub(c),h=he+a.radius,u=l.length();if(u>0&&u<h){let f=l.multiplyScalar(1/u);i.group.position.x+=f.x*(h-u),i.group.position.y+=f.y*(h-u);let p=wo(i,f,c,dh(a.gear,c));fh(a.gear,c,f,p)}}}}}function wg(i,t){i.velocity.y-=nh*t,i.velocity.multiplyScalar(.999),i.angularVelocity*=.999,i.group.position.x+=i.velocity.x*t,i.group.position.y+=i.velocity.y*t,i.group.rotation.z+=i.angularVelocity*t,Tg(i)}function Xa(i,t,e=he,n=.42,s=null,r=null){let o=new ct(Lt.position.x,Lt.position.y),a=Ro(o,i,t),c=o.clone().sub(a),l=Se+e,h=c.length();if(h>=l||h===0)return;let u=c.multiplyScalar(1/h);o.addScaledVector(u,l-h),Lt.position.x=o.x,Lt.position.y=o.y;let f=new ct;if(s){let y=a.clone().sub(new ct(s.group.position.x,s.group.position.y));f=s.velocity.clone().add(new ct(-s.angularVelocity*y.y,s.angularVelocity*y.x))}r&&(f=dh(r,a));let _=me.clone().sub(f).dot(u);if(_<0){let y=s?a.clone().sub(new ct(s.group.position.x,s.group.position.y)):null,m=s?Math.pow(Co(y,u),2)/s.inertia:0,d=1/Wc+(s?1/s.mass:0)+m,w=-(1+n)*_/d;me.addScaledVector(u,w/Wc),s&&(s.velocity.addScaledVector(u,-w/s.mass),s.angularVelocity-=Co(y,u)*w/s.inertia),r&&fh(r,a,u,w)}me.multiplyScalar(.994)}function Ag(i){let t=new ct(Lt.position.x-i.x,Lt.position.y-i.y),e=Se+i.r,n=t.length();if(n>=e||n===0)return;let s=t.multiplyScalar(1/n);Lt.position.x=i.x+s.x*e,Lt.position.y=i.y+s.y*e;let r=me.dot(s);r<0&&me.addScaledVector(s,-1.48*r)}function Rg(){let i=$a();Lt.position.x-Se<i.left&&(Lt.position.x=i.left+Se,me.x=Math.abs(me.x)*.55),Lt.position.x+Se>i.right&&(Lt.position.x=i.right-Se,me.x=-Math.abs(me.x)*.55),Lt.position.y-Se<i.bottom&&(Lt.position.y=i.bottom+Se,me.y=Math.abs(me.y)*.42,me.x*=.96),Lt.position.y+Se>i.top&&(Lt.position.y=i.top-Se,me.y=-Math.abs(me.y)*.45)}function Cg(i){ee.forEach(t=>wg(t,i)),Lt&&(me.y-=nh*i,me.multiplyScalar(.999),Lt.position.x+=me.x*i,Lt.position.y+=me.y*i,Rg(),Os.forEach(Ag),es.forEach(t=>Xa(t.a,t.b,t.radius,.4)),Nn.flatMap(Ja).forEach(t=>Xa(t.a,t.b,t.radius,.4,null,t.gear)),ee.forEach(t=>{let e=Fs(t);for(let n=1;n<e.length;n++)Xa(e[n-1],e[n],he,.32,t)})),ph()}function ph(){if(xn)return;let i=Me[De].goal;if(i&&(i.type==="draw"&&ee.length>0||i.type==="ballBox"&&Lt&&Jt&&Lt.position.x>Jt.left+Se&&Lt.position.x<Jt.right-Se&&Lt.position.y<Jt.top&&Lt.position.y>Jt.bottom||i.type==="strokeBox"&&Jt&&ee.some(t=>Fs(t).every(e=>e.x>Jt.left+he&&e.x<Jt.right-he&&e.y>Jt.bottom+he&&e.y<Jt.top-he))||i.type==="target"&&Lt&&new ct(Lt.position.x,Lt.position.y).distanceTo(new ct(i.x,i.y))<i.r||i.type==="wall"&&Lt&&(i.side==="left"?Lt.position.x<=pe.left+Se+.18:Lt.position.x>=pe.right-Se-.18)&&Lt.position.y>=i.minY&&Lt.position.y<=i.maxY||i.type==="spinGear"&&Nn.some(t=>t.mode==="impact"&&Math.abs(t.angularVelocity)>=i.speed)))return Qi()}function Qi(){if(xn)return;on=!1,xn=!0;let i=Math.max(rh(),Math.min(Me.length,De+2));hg(i);let t=Me[De],e=1+(ee.length<=t.parStrokes?1:0)+(ts<=t.parTime?1:0);ug(De,e),Us.innerHTML=`<div class="win-stars">${"\u2605".repeat(e)}${"\u2606".repeat(3-e)}</div><div>\u904E\u95DC\uFF01 ${ts.toFixed(1)} \u79D2\u30FB${ee.length} \u7B46</div><div class="result-actions"><button data-result-action="levels">\u9078\u95DC</button><button data-result-action="next">${De===Me.length-1?"\u5B8C\u6210":"\u4E0B\u4E00\u95DC"}</button></div>`,Us.className="result-banner success show",ji.textContent="\u6F02\u4EAE\u7684\u7269\u7406\u89E3\u6CD5\uFF01",navigator.vibrate&&navigator.vibrate([40,40,100]),Bs()}function mh(){let i=rh(),t=oh(),e=Object.values(t).reduce((n,s)=>n+Number(s||0),0);jm.textContent=`\u5DF2\u89E3\u9396 ${i} / ${Me.length}\u3000\u2605 ${e} / ${Me.length*3}`,qa.innerHTML=Me.map((n,s)=>{let r=s+1>i,o=Number(t[s])||0,a=n.chapter??"\u57FA\u790E\u8AB2\u7A0B",c=s?Me[s-1].chapter??"\u57FA\u790E\u8AB2\u7A0B":null;return`${a!==c?`<h2 class="chapter-heading"><span>${a}</span><small>${String(s+1).padStart(2,"0")}\u2014${String(Math.min(Me.length,s+(a==="\u57FA\u790E\u8AB2\u7A0B"?12:10))).padStart(2,"0")}</small></h2>`:""}<button class="level-card" data-level="${s}" ${r?"disabled":""}>
    ...
    </button>`}).join(""),requestAnimationFrame(()=>qa.querySelector(`[data-level="${Math.max(0,i-1)}"]`)?.scrollIntoView({block:"center"}))}function gh(){on=!1,xn=!1,th.classList.add("hidden"),jc.classList.remove("hidden"),mh()}function Io(i){De=i;let t=Me[i];on=!1,xn=!1,be&&be.meshes.forEach(e=>Jn.remove(e)),be=null,ee.forEach(Ka),ee=[],Jn.clear(),mg(),Ns=t.strokes,gg(t),eh.textContent=String(i+1).padStart(2,"0"),tg.textContent=t.mission,eg.textContent=t.hintTitle,ng.textContent=t.hint,jc.classList.add("hidden"),th.classList.remove("hidden"),Qa(),requestAnimationFrame(_h)}Qc.addEventListener("click",Sg);Qm.addEventListener("click",Qa);eh.addEventListener("click",gh);qa.addEventListener("click",i=>{let t=i.target.closest("[data-level]");t&&!t.disabled&&Io(Number(t.dataset.level))});Us.addEventListener("click",i=>{let t=i.target.closest("[data-result-action]")?.dataset.resultAction;(t==="levels"||De===Me.length-1)&&gh(),t==="next"&&De<Me.length-1&&Io(De+1)});document.querySelector("#hintButton").addEventListener("click",()=>Za.showModal());document.querySelector("#closeHint").addEventListener("click",()=>Za.close());document.querySelector("#gotItButton").addEventListener("click",()=>Za.close());function _h(){let i=Jc.getBoundingClientRect();if(i.width<10||i.height<10)return;Je.setSize(i.width,i.height,!1);let t=i.width/Math.max(i.height,1),e=(pe.right-pe.left)/(pe.top-pe.bottom);if(t>e){let n=(pe.top-pe.bottom)*t;de.left=-n/2,de.right=n/2,de.top=pe.top,de.bottom=pe.bottom}else{let n=(pe.right-pe.left)/t;de.left=pe.left,de.right=pe.right,de.top=n/2,de.bottom=-n/2}de.updateProjectionMatrix()}new ResizeObserver(_h).observe($m);var Ig=new Es;function xh(){let i=Math.min(Ig.getDelta(),.05);if(Eg(i),on)for(ts=(performance.now()-sh)/1e3,Kc.textContent=ts.toFixed(1),Ao+=i;Ao>=1/120;)Cg(1/120),Ao-=1/120;Je.render(ih,de),requestAnimationFrame(xh)}var $c=document.modelContext;if($c?.registerTool)try{Promise.resolve($c.registerTool({name:"reset_physics_puzzle",title:"\u91CD\u8A2D\u7269\u7406\u89E3\u8B0E",description:"\u6E05\u9664\u73A9\u5BB6\u756B\u7684\u8DEF\u7DDA\u4E26\u628A\u6A58\u7403\u653E\u56DE\u8D77\u9EDE\u3002",inputSchema:{type:"object",properties:{},additionalProperties:!1},annotations:{readOnlyHint:!1,untrustedContentHint:!1},execute(){return Lt?Qa():Io(De),{status:"ready",strokes:0}}})).catch(()=>{})}catch{}window.__gameDebug={loadLevel:Io,getState(){return{running:on,finished:xn,strokes:ee.length,staticSegments:es.length,gears:Nn.map(i=>({mode:i.mode,angle:i.group.rotation.z,speed:i.angularVelocity})),level:De+1,levelName:Me[De].name,chapter:Me[De].chapter??"\u57FA\u790E\u8AB2\u7A0B",goal:Me[De].goal?.type??null,ball:Lt?{x:Lt.position.x,y:Lt.position.y}:null,firstStrokeY:ee[0]?.group.position.y??null,firstStrokeAngle:ee[0]?.group.rotation.z??null,firstStrokeAngularVelocity:ee[0]?.angularVelocity??null,firstStrokeMass:ee[0]?.mass??null,firstStrokeInertia:ee[0]?.inertia??null}}};mh();xh();document.documentElement.dataset.gameReady="true";})();
/**
 * @license
